...
void main() {
  ...
  group('int base type', () {
    ...
    test('should return true when filtering with int', () {
      expect(filter(22), true);
    });

    test('should return false when filtering with float', () {
      expect(
        filter(22.5, type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
    ...
    test('should return false when filtering with invalid string', () {
      expect(
        filter('invalid', type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
    ...
    test('should return false when filtering with bool', () {
      expect(
        filter(true, type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
    ...
    test('should return false when filtering with datetime literal', () {
      expect(
        filter(DateTime(2022, 1, 1), type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
    ...
    test('should return false when filtering with datetime string', () {
      expect(
        filter('2022-01-01', type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
    ...
    test('should return false when filtering with range string', () {
      expect(
        filter('[10,20]', type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
    ...
    test('should return false when filtering with json literal', () {
      expect(
        filter({'value': 10}, type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
    ...
    test('should return false when filtering with int list', () {
      expect(
        filter([1, 2, 3, 4], type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
    ...
    test('should return false when filtering with float list', () {
      expect(
        filter([1.5, 2.5, 3.5, 4.5], type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
  ...
  group('float base type', () {
    ...
    test('should return true when filtering with float', () {
      expect(filter(22.5), true);
    });
  ...
  group('string base type', () {
    ...
    test('should return true when filtering with invalid string', () {
      expect(filter('invalid'), true);
    });

    test('should return true when filtering with bool', () {
      expect(filter(true), true);
    });

    test('should return true when filtering with datetime literal', () {
      expect(filter(DateTime(2022, 1, 1)), true);
    });

    test('should return true when filtering with datetime string', () {
      expect(filter('2022-01-01'), true);
    });

    test('should return true when filtering with range string', () {
      expect(filter('[10,20]'), true);
    });

    test('should return true when filtering with range literal', () {
      expect(filter(RangeType.createRange(range: '[10,20]')), true);
    });

    test('should return true when filtering with json literal', () {
      expect(filter({'value': 10}), true);
    });

    test('should return true when filtering with json string', () {
      expect(filter('{"value": 10}'), true);
    });
  ...
  group('bool base type', () {
    ...
    test('should return false when filtering with int', () {
      expect(
        filter(22, type: FilterErrorTypes.invalidInputSyntax),
        false,
      );
    });
  ...
  group('datetime base type', () {
    ...
    test('should return false when filtering with int', () {
      expect(
        filter(22, type: FilterErrorTypes.datetimeOutOfRange),
        false,
      );
    });
  ...
  group('datetime list base type', () {
    ...
    test('should return true when filtering with valid string', () {
      expect(filter('{2022-01-01, 2022-12-31}'), true);
    });
