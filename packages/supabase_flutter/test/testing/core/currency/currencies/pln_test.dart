...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.pln;
    const amount = r'zł2123456789,35';
    const expected = r'zł2.123.456.789,35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.pln;
    const amount = r'-zł20386,47';
    const expected = r'-zł20.386,47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.pln;
    const amount = r'zł2.12345.6789,35';
    const expected = r'zł2.123.456.789,35';
    final operation = currency(amount, currencyValue);
