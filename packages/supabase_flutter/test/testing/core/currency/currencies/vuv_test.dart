...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.vuv;
    const amount = r'2123456789VT';
    const expected = r'2,123,456,789VT';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.vuv;
    const amount = r'-20386VT';
    const expected = r'-20,386VT';
    final operation = currency(amount, currencyValue);
