...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.pen;
    const amount = r'S/.2123456789.35';
    const expected = r'S/.2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.pen;
    const amount = r'S/.2,12345,6789.35';
    const expected = r'S/.2,123,456,789.35';
    final operation = currency(amount, currencyValue);
