...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.mkd;
    const amount = r'2123456789,35ден';
    const expected = r'2.123.456.789,35ден';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mkd;
    const amount = r'-20386,47ден';
    const expected = r'-20.386,47ден';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mkd;
    const amount = r'2.12345.6789,35ден';
    const expected = r'2.123.456.789,35ден';
    final operation = currency(amount, currencyValue);
