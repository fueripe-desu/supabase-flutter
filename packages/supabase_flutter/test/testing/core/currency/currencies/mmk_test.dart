...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.mmk;
    const amount = r'Ks2123456789.35';
    const expected = r'Ks2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mmk;
    const amount = r'-Ks20386.47';
    const expected = r'-Ks20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mmk;
    const amount = r'Ks2,12345,6789.35';
    const expected = r'Ks2,123,456,789.35';
    final operation = currency(amount, currencyValue);
