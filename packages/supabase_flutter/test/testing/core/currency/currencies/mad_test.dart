...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.mad;
    const amount = r'2123456789,35د.م.';
    const expected = r'2.123.456.789,35د.م.';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mad;
    const amount = r'-20386,47د.م.';
    const expected = r'-20.386,47د.م.';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mad;
    const amount = r'2.12345.6789,35د.م.';
    const expected = r'2.123.456.789,35د.م.';
    final operation = currency(amount, currencyValue);
