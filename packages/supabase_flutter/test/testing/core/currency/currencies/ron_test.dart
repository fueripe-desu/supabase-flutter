...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.ron;
    const amount = r'2123456789,35lei';
    const expected = r'2.123.456.789,35lei';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.ron;
    const amount = r'-20386,47lei';
    const expected = r'-20.386,47lei';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.ron;
    const amount = r'2.12345.6789,35lei';
    const expected = r'2.123.456.789,35lei';
    final operation = currency(amount, currencyValue);
