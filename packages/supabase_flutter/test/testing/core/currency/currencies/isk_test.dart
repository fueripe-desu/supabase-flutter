...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.isk;
    const amount = r'kr2123456789';
    const expected = r'kr2.123.456.789';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.isk;
    const amount = r'-kr20386';
    const expected = r'-kr20.386';
    final operation = currency(amount, currencyValue);
