...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.bgn;
    const amount = r'2123456789,35лв';
    const expected = r'2 123 456 789,35лв';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.bgn;
    const amount = r'-20386,47лв';
    const expected = r'-20 386,47лв';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.bgn;
    const amount = r'2 12345 6789,35лв';
    const expected = r'2 123 456 789,35лв';
    final operation = currency(amount, currencyValue);
