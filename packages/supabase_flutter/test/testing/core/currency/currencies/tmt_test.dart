...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.tmt;
    const amount = r'2123456789.35m';
    const expected = r'2,123,456,789.35m';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.tmt;
    const amount = r'-20386.47m';
    const expected = r'-20,386.47m';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.tmt;
    const amount = r'2,12345,6789.35m';
    const expected = r'2,123,456,789.35m';
    final operation = currency(amount, currencyValue);
