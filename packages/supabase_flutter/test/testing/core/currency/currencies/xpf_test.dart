...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.xpf;
    const amount = r'XPF2123456789';
    const expected = r'XPF2 123 456 789';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.xpf;
    const amount = r'-XPF20386';
    const expected = r'-XPF20 386';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.xpf;
    const amount = r'XPF2 12345 6789';
    const expected = r'XPF2 123 456 789';
    final operation = currency(amount, currencyValue);
