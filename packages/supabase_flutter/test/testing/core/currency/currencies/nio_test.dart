...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.nio;
    const amount = r'C$2123456789.35';
    const expected = r'C$2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.nio;
    const amount = r'-C$20386.47';
    const expected = r'-C$20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.nio;
    const amount = r'C$2,12345,6789.35';
    const expected = r'C$2,123,456,789.35';
    final operation = currency(amount, currencyValue);
