...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.sle;
    const amount = r'Le2123456789.35';
    const expected = r'Le2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.sle;
    const amount = r'-Le20386.47';
    const expected = r'-Le20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.sle;
    const amount = r'Le2,12345,6789.35';
    const expected = r'Le2,123,456,789.35';
    final operation = currency(amount, currencyValue);
