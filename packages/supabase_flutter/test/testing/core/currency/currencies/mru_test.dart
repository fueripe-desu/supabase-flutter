...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.mru;
    const amount = r'UM2123456796.00';
    const expected = r'UM2,123,456,796.00';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mru;
    const amount = r'-UM20395.20';
    const expected = r'-UM20,399.00';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mru;
    const amount = r'UM2,12345,6796.00';
    const expected = r'UM2,123,456,796.00';
    final operation = currency(amount, currencyValue);
