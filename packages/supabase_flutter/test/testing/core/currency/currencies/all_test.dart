...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.all;
    const amount = r'L2123456789.35';
    const expected = r'L2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.all;
    const amount = r'-L20386.47';
    const expected = r'-L20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.all;
    const amount = r'L2,12345,6789.35';
    const expected = r'L2,123,456,789.35';
    final operation = currency(amount, currencyValue);
