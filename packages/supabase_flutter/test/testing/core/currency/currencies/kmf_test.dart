...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.kmf;
    const amount = r'CF2123456789';
    const expected = r'CF2,123,456,789';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.kmf;
    const amount = r'-CF20386';
    const expected = r'-CF20,386';
    final operation = currency(amount, currencyValue);
