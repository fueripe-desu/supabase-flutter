...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.czk;
    const amount = r'Kč2123456789.35';
    const expected = r'Kč2 123 456 789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.czk;
    const amount = r'-Kč20386.47';
    const expected = r'-Kč20 386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.czk;
    const amount = r'Kč2 12345 6789.35';
    const expected = r'Kč2 123 456 789.35';
    final operation = currency(amount, currencyValue);
