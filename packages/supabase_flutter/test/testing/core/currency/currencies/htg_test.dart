...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.htg;
    const amount = r'G2123456789.35';
    const expected = r'G2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.htg;
    const amount = r'-G20386.47';
    const expected = r'-G20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.htg;
    const amount = r'G2,12345,6789.35';
    const expected = r'G2,123,456,789.35';
    final operation = currency(amount, currencyValue);
