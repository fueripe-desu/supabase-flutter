...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.mvr;
    const amount = r'2123456789.35ރ.';
    const expected = r'2,123,456,789.35ރ.';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mvr;
    const amount = r'-20386.47ރ.';
    const expected = r'-20,386.47ރ.';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mvr;
    const amount = r'2,12345,6789.35ރ.';
    const expected = r'2,123,456,789.35ރ.';
    final operation = currency(amount, currencyValue);
