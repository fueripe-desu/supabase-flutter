...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.gmd;
    const amount = r'D2123456789.35';
    const expected = r'D2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.gmd;
    const amount = r'-D20386.47';
    const expected = r'-D20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.gmd;
    const amount = r'D2,12345,6789.35';
    const expected = r'D2,123,456,789.35';
    final operation = currency(amount, currencyValue);
