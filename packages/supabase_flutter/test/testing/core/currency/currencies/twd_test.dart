...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.twd;
    const amount = r'NT$2123456789';
    const expected = r'NT$2,123,456,789';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.twd;
    const amount = r'-NT$20386';
    const expected = r'-NT$20,386';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.twd;
    const amount = r'NT$2,12345,6789';
    const expected = r'NT$2,123,456,789';
    final operation = currency(amount, currencyValue);
