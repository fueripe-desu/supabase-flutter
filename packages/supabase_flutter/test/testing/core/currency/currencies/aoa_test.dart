...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.aoa;
    const amount = r'2123456789,35Kz';
    const expected = r'2.123.456.789,35Kz';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.aoa;
    const amount = r'-20386,47Kz';
    const expected = r'-20.386,47Kz';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.aoa;
    const amount = r'2.12345.6789,35Kz';
    const expected = r'2.123.456.789,35Kz';
    final operation = currency(amount, currencyValue);
