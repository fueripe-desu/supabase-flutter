...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.dzd;
    const amount = r'2123456789.35د.ج';
    const expected = r'2,123,456,789.35د.ج';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.dzd;
    const amount = r'-20386.47د.ج';
    const expected = r'-20,386.47د.ج';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.dzd;
    const amount = r'2,12345,6789.35د.ج';
    const expected = r'2,123,456,789.35د.ج';
    final operation = currency(amount, currencyValue);
