...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.huf;
    const amount = r'Ft2123456789';
    const expected = r'Ft2,123,456,789';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.huf;
    const amount = r'-Ft20386';
    const expected = r'-Ft20,386';
    final operation = currency(amount, currencyValue);
