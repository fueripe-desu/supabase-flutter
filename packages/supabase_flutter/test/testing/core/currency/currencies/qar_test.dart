...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.qar;
    const amount = r'2123456789.35ر.ق';
    const expected = r'2,123,456,789.35ر.ق';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.qar;
    const amount = r'-20386.47ر.ق';
    const expected = r'-20,386.47ر.ق';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.qar;
    const amount = r'2,12345,6789.35ر.ق';
    const expected = r'2,123,456,789.35ر.ق';
    final operation = currency(amount, currencyValue);
