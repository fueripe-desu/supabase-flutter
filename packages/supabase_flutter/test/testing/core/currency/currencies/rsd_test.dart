...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.rsd;
    const amount = r'дин.2123456789,35';
    const expected = r'дин.2.123.456.789,35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.rsd;
    const amount = r'-дин.20386,47';
    const expected = r'-дин.20.386,47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.rsd;
    const amount = r'дин.2.12345.6789,35';
    const expected = r'дин.2.123.456.789,35';
    final operation = currency(amount, currencyValue);
