...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.aed;
    const amount = r'2123456789.35د.إ';
    const expected = r'2,123,456,789.35د.إ';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.aed;
    const amount = r'-20386.47د.إ';
    const expected = r'-20,386.47د.إ';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.aed;
    const amount = r'2,12345,6789.35د.إ';
    const expected = r'2,123,456,789.35د.إ';
    final operation = currency(amount, currencyValue);
