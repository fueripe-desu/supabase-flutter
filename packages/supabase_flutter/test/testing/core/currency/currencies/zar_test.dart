...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.zar;
    const amount = r'R2123456789.35';
    const expected = r'R2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.zar;
    const amount = r'-R20386.47';
    const expected = r'-R20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.zar;
    const amount = r'R2,12345,6789.35';
    const expected = r'R2,123,456,789.35';
    final operation = currency(amount, currencyValue);
