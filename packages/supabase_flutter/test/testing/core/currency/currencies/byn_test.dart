...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.byn;
    const amount = r'2123456789,35Br';
    const expected = r'2 123 456 789,35Br';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.byn;
    const amount = r'-20386,47Br';
    const expected = r'-20 386,47Br';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.byn;
    const amount = r'2 12345 6789,35Br';
    const expected = r'2 123 456 789,35Br';
    final operation = currency(amount, currencyValue);
