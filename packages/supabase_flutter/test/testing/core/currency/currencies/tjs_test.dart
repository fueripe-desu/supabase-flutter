...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.tjs;
    const amount = r'ЅM2123456789.35';
    const expected = r'ЅM2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.tjs;
    const amount = r'-ЅM20386.47';
    const expected = r'-ЅM20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.tjs;
    const amount = r'ЅM2,12345,6789.35';
    const expected = r'ЅM2,123,456,789.35';
    final operation = currency(amount, currencyValue);
