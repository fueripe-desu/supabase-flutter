...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.xof;
    const amount = r'CFA2123456789';
    const expected = r'CFA2 123 456 789';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.xof;
    const amount = r'-CFA20386';
    const expected = r'-CFA20 386';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.xof;
    const amount = r'CFA2 12345 6789';
    const expected = r'CFA2 123 456 789';
    final operation = currency(amount, currencyValue);
