...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.etb;
    const amount = r'Br2123456789.35';
    const expected = r'Br2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.etb;
    const amount = r'-Br20386.47';
    const expected = r'-Br20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.etb;
    const amount = r'Br2,12345,6789.35';
    const expected = r'Br2,123,456,789.35';
    final operation = currency(amount, currencyValue);
