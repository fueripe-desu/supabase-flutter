...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.kwd;
    const amount = r'2123456789.325د.ك';
    const expected = r'2,123,456,789.325د.ك';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.kwd;
    const amount = r'-20386.477د.ك';
    const expected = r'-20,386.477د.ك';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.kwd;
    const amount = r'2,12345,6789.357د.ك';
    const expected = r'2,123,456,789.357د.ك';
    final operation = currency(amount, currencyValue);
