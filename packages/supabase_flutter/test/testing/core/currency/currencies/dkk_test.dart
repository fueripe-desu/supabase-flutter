...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.dkk;
    const amount = r'kr2123456789,35';
    const expected = r'kr2.123.456.789,35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.dkk;
    const amount = r'-kr20386,47';
    const expected = r'-kr20.386,47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.dkk;
    const amount = r'kr2.12345.6789,35';
    const expected = r'kr2.123.456.789,35';
    final operation = currency(amount, currencyValue);
