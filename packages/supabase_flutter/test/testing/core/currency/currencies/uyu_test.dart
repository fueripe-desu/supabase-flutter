...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.uyu;
    const amount = r'$U2123456789.35';
    const expected = r'$U2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.uyu;
    const amount = r'-$U20386.47';
    const expected = r'-$U20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.uyu;
    const amount = r'$U2,12345,6789.35';
    const expected = r'$U2,123,456,789.35';
    final operation = currency(amount, currencyValue);
