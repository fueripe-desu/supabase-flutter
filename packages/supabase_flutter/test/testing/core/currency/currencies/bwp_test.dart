...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.bwp;
    const amount = r'P2123456789.35';
    const expected = r'P2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.bwp;
    const amount = r'-P20386.47';
    const expected = r'-P20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.bwp;
    const amount = r'P2,12345,6789.35';
    const expected = r'P2,123,456,789.35';
    final operation = currency(amount, currencyValue);
