...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.myr;
    const amount = r'RM2123456789.35';
    const expected = r'RM2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.myr;
    const amount = r'-RM20386.47';
    const expected = r'-RM20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.myr;
    const amount = r'RM2,12345,6789.35';
    const expected = r'RM2,123,456,789.35';
    final operation = currency(amount, currencyValue);
