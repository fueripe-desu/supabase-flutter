...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.uzs;
    const amount = r'soʻm2123456789.35';
    const expected = r'soʻm2 123 456 789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.uzs;
    const amount = r'-soʻm20386.47';
    const expected = r'-soʻm20 386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.uzs;
    const amount = r'soʻm2 12345 6789.35';
    const expected = r'soʻm2 123 456 789.35';
    final operation = currency(amount, currencyValue);
