...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.ern;
    const amount = r'Nfk2123456789.35';
    const expected = r'Nfk2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.ern;
    const amount = r'-Nfk20386.47';
    const expected = r'-Nfk20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.ern;
    const amount = r'Nfk2,12345,6789.35';
    const expected = r'Nfk2,123,456,789.35';
    final operation = currency(amount, currencyValue);
