...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.sos;
    const amount = r'S2123456789.35';
    const expected = r'S2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.sos;
    const amount = r'-S20386.47';
    const expected = r'-S20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.sos;
    const amount = r'S2,12345,6789.35';
    const expected = r'S2,123,456,789.35';
    final operation = currency(amount, currencyValue);
