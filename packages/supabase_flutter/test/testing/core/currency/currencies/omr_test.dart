...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.omr;
    const amount = r'2123456789.325ر.ع.';
    const expected = r'2,123,456,789.325ر.ع.';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.omr;
    const amount = r'-20386.477ر.ع.';
    const expected = r'-20,386.477ر.ع.';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.omr;
    const amount = r'2,12345,6789.357ر.ع.';
    const expected = r'2,123,456,789.357ر.ع.';
    final operation = currency(amount, currencyValue);
