...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.bob;
    const amount = r'Bs.2123456789.35';
    const expected = r'Bs.2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.bob;
    const amount = r'-Bs.20386.47';
    const expected = r'-Bs.20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.bob;
    const amount = r'Bs.2,12345,6789.35';
    const expected = r'Bs.2,123,456,789.35';
    final operation = currency(amount, currencyValue);
