...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.mwk;
    const amount = r'MK2123456789.35';
    const expected = r'MK2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mwk;
    const amount = r'-MK20386.47';
    const expected = r'-MK20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mwk;
    const amount = r'MK2,12345,6789.35';
    const expected = r'MK2,123,456,789.35';
    final operation = currency(amount, currencyValue);
