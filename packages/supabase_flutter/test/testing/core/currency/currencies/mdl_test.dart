...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.mdl;
    const amount = r'2123456789.35L';
    const expected = r'2,123,456,789.35L';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mdl;
    const amount = r'-20386.47L';
    const expected = r'-20,386.47L';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.mdl;
    const amount = r'2,12345,6789.35L';
    const expected = r'2,123,456,789.35L';
    final operation = currency(amount, currencyValue);
