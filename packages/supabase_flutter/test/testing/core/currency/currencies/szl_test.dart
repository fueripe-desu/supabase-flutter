...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.szl;
    const amount = r'E2123456789.35';
    const expected = r'E2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.szl;
    const amount = r'-E20386.47';
    const expected = r'-E20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.szl;
    const amount = r'E2,12345,6789.35';
    const expected = r'E2,123,456,789.35';
    final operation = currency(amount, currencyValue);
