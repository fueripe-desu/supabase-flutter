...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.lbp;
    const amount = r'2123456789.35ل.ل';
    const expected = r'2,123,456,789.35ل.ل';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.lbp;
    const amount = r'-20386.47ل.ل';
    const expected = r'-20,386.47ل.ل';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.lbp;
    const amount = r'2,12345,6789.35ل.ل';
    const expected = r'2,123,456,789.35ل.ل';
    final operation = currency(amount, currencyValue);
