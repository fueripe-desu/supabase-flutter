...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.kgs;
    const amount = r'2123456789.35сом';
    const expected = r'2 123 456 789.35сом';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.kgs;
    const amount = r'-20386.47сом';
    const expected = r'-20 386.47сом';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.kgs;
    const amount = r'2 12345 6789.35сом';
    const expected = r'2 123 456 789.35сом';
    final operation = currency(amount, currencyValue);
