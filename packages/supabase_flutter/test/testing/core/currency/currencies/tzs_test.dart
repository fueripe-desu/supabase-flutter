...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.tzs;
    const amount = r'Sh2123456789.35';
    const expected = r'Sh2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.tzs;
    const amount = r'-Sh20386.47';
    const expected = r'-Sh20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.tzs;
    const amount = r'Sh2,12345,6789.35';
    const expected = r'Sh2,123,456,789.35';
    final operation = currency(amount, currencyValue);
