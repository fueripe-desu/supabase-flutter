...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.chf;
    const amount = r'Fr2123456789.35';
    const expected = r'Fr2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.chf;
    const amount = r'-Fr20386.47';
    const expected = r'-Fr20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.chf;
    const amount = r'Fr2,12345,6789.35';
    const expected = r'Fr2,123,456,789.35';
    final operation = currency(amount, currencyValue);
