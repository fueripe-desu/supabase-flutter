...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.iqd;
    const amount = r'2123456789.325ع.د';
    const expected = r'2,123,456,789.325ع.د';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.iqd;
    const amount = r'-20386.477ع.د';
    const expected = r'-20,386.477ع.د';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.iqd;
    const amount = r'2,12345,6789.357ع.د';
    const expected = r'2,123,456,789.357ع.د';
    final operation = currency(amount, currencyValue);
