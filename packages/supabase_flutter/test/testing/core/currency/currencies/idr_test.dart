...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.idr;
    const amount = r'Rp2123456789.35';
    const expected = r'Rp2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.idr;
    const amount = r'-Rp20386.47';
    const expected = r'-Rp20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.idr;
    const amount = r'Rp2,12345,6789.35';
    const expected = r'Rp2,123,456,789.35';
    final operation = currency(amount, currencyValue);
