...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.stn;
    const amount = r'Db2123456789.35';
    const expected = r'Db2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.stn;
    const amount = r'-Db20386.47';
    const expected = r'-Db20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.stn;
    const amount = r'Db2,12345,6789.35';
    const expected = r'Db2,123,456,789.35';
    final operation = currency(amount, currencyValue);
