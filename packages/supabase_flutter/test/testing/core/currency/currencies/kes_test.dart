...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.kes;
    const amount = r'Ksh2123456789.35';
    const expected = r'Ksh2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.kes;
    const amount = r'-Ksh20386.47';
    const expected = r'-Ksh20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.kes;
    const amount = r'Ksh2,12345,6789.35';
    const expected = r'Ksh2,123,456,789.35';
    final operation = currency(amount, currencyValue);
