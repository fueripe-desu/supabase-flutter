...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.gtq;
    const amount = r'Q2123456789.35';
    const expected = r'Q2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.gtq;
    const amount = r'-Q20386.47';
    const expected = r'-Q20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.gtq;
    const amount = r'Q2,12345,6789.35';
    const expected = r'Q2,123,456,789.35';
    final operation = currency(amount, currencyValue);
