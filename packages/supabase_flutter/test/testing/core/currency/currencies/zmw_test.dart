...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.zmw;
    const amount = r'ZK2123456789.35';
    const expected = r'ZK2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.zmw;
    const amount = r'-ZK20386.47';
    const expected = r'-ZK20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.zmw;
    const amount = r'ZK2,12345,6789.35';
    const expected = r'ZK2,123,456,789.35';
    final operation = currency(amount, currencyValue);
