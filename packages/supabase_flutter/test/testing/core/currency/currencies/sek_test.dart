...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.sek;
    const amount = r'2123456789,35kr';
    const expected = r'2 123 456 789,35kr';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.sek;
    const amount = r'-20386,47kr';
    const expected = r'-20 386,47kr';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.sek;
    const amount = r'2 12345 6789,35kr';
    const expected = r'2 123 456 789,35kr';
    final operation = currency(amount, currencyValue);
