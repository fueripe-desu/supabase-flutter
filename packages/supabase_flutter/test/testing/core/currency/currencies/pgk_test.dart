...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.pgk;
    const amount = r'K2123456789.35';
    const expected = r'K2,123,456,789.35';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.pgk;
    const amount = r'-K20386.47';
    const expected = r'-K20,386.47';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.pgk;
    const amount = r'K2,12345,6789.35';
    const expected = r'K2,123,456,789.35';
    final operation = currency(amount, currencyValue);
