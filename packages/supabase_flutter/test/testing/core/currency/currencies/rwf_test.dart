...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.rwf;
    const amount = r'RF2123456789';
    const expected = r'RF2,123,456,789';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.rwf;
    const amount = r'-RF20386';
    const expected = r'-RF20,386';
    final operation = currency(amount, currencyValue);
