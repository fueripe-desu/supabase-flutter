...
void main() {
  ...
  test('should display correctly display a positive value', () {
    final currencyValue = Currencies.ugx;
    const amount = r'USh2123456789';
    const expected = r'USh2,123,456,789';
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.ugx;
    const amount = r'-USh20386';
    const expected = r'-USh20,386';
    final operation = currency(amount, currencyValue);
  ...
  test(
      ...
      () {
    final currencyValue = Currencies.ugx;
    const amount = r'USh2,12345,6789';
    const expected = r'USh2,123,456,789';
    final operation = currency(amount, currencyValue);
