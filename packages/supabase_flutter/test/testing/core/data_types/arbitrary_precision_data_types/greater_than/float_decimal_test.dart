...
void main() {
  group('positive comparison (greater)', () {
    ...
    test('should return true when comparing to fractional Numeric', () {
      final value1 = Decimal(value: '0.58', precision: 3, scale: 2);
  ...
  group('positive comparison (less)', () {
    test('should return false when comparing to BigInteger', () {
      final value1 = Decimal(value: '19.9', precision: 3, scale: 1);
      final value2 = BigInteger(20);
      final operation = value1 > value2;
    ...
    test('should return false when comparing to fractional Numeric', () {
      final value1 = Decimal(value: '0.19', precision: 3, scale: 2);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
      final operation = value1 > value2;
      expect(operation, false);
    });
  ...
  group('negative comparison (greater)', () {
    test('should return true when comparing to BigInteger', () {
      final value1 = Decimal(value: '-19.6', precision: 3, scale: 1);
      final value2 = BigInteger(-20);
      final operation = value1 > value2;
      expect(operation, true);
    });
    ...
    test('should return true when comparing to fractional double', () {
      final value1 = Decimal(value: '-20.1', precision: 3, scale: 1);
      const value2 = -20.3;
      final operation = value1 > value2;
      expect(operation, true);
    });
    ...
    test('should return true when comparing to fractional Numeric', () {
      final value1 = Decimal(value: '-0.12', precision: 3, scale: 2);
      final value2 = Numeric(value: '-0.35', precision: 2, scale: 2);
      final operation = value1 > value2;
      expect(operation, true);
    });
    ...
    test('should return true when comparing to fractional Decimal', () {
      final value1 = Decimal(value: '-0.12', precision: 3, scale: 1);
      final value2 = Decimal(value: '-0.35', precision: 2, scale: 2);
      final operation = value1 > value2;
      expect(operation, true);
    });
  ...
  group('mixed sign comparison (positive + negative)', () {
    ...
    test('should return true when comparing to fractional Decimal', () {
      final value1 = Decimal(value: '0.58', precision: 3, scale: 1);
      final value2 = Decimal(value: '-0.35', precision: 2, scale: 2);
      final operation = value1 > value2;
      expect(operation, true);
    });
  ...
  group('zero comparison (greater)', () {
    test('should return true when comparing to BigInteger', () {
      final value1 = Decimal(value: '0.1', precision: 2, scale: 1);
  ...
  group('large double comparison (greater)', () {
    test('should return true when comparing to integer-valued double', () {
      final value1 = Decimal(value: '1.3e20', precision: 21, scale: 0);
      const value2 = 1e10;
      final operation = value1 > value2;
      expect(operation, true);
    });
  ...
  group('large double comparison (equal)', () {
    test('should return false when comparing to fractional double', () {
      final value1 = Decimal(value: '1.6e20', precision: 21, scale: 0);
      const value2 = 1.6e20;
      final operation = value1 > value2;
      expect(operation, false);
    });
  ...
  group('positive close proximity comparison (greater)', () {
    test('should return true when comparing to BigInteger', () {
      final value1 = Decimal(value: '20.00001', precision: 7, scale: 5);
      final value2 = BigInteger(20);
      final operation = value1 > value2;
      expect(operation, true);
    });
    ...
    test('should return true when comparing to fractional double', () {
      final value1 = Decimal(value: '20.30001', precision: 7, scale: 5);
      const value2 = 20.3;
      final operation = value1 > value2;
      expect(operation, true);
    });
    ...
    test('should return true when comparing to fractional Numeric', () {
      final value1 = Decimal(value: '0.35001', precision: 6, scale: 5);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
      final operation = value1 > value2;
      expect(operation, true);
    });
  ...
  group('positive close proximity comparison (less)', () {
    test('should return false when comparing to BigInteger', () {
      final value1 = Decimal(value: '19.99999', precision: 7, scale: 5);
      final value2 = BigInteger(20);
      final operation = value1 > value2;
      expect(operation, false);
    });
    ...
    test('should return false when comparing to fractional double', () {
      final value1 = Decimal(value: '20.59999', precision: 7, scale: 5);
      const value2 = 20.6;
      final operation = value1 > value2;
      expect(operation, false);
    });
    ...
    test('should return false when comparing to fractional Numeric', () {
      final value1 = Decimal(value: '0.34999', precision: 6, scale: 5);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
      final operation = value1 > value2;
      expect(operation, false);
    });
  ...
  group('negative close proximity comparison (greater)', () {
    ...
    test('should return true when comparing to integer-valued Real', () {
      final value1 = Decimal(value: '-9.99999', precision: 6, scale: 5);
      final value2 = Real(-20.0);
      final operation = value1 > value2;
      expect(operation, true);
    });
  ...
  group('zero cases', () {
    test(
        'should return false when comparing positive zero to negative Decimal zero',
        () {
      final value1 = Decimal(value: '0.0', precision: 2, scale: 1);
      final value2 = Decimal(value: '-0.0', precision: 2, scale: 1);
      final operation = value1 > value2;
      expect(operation, false);
    });
    ...
    test(
        'should return false when comparing positive zero to negative Numeric zero',
        () {
      final value1 = Decimal(value: '0.0', precision: 2, scale: 1);
      final value2 = Numeric(value: '-0.0', precision: 2, scale: 1);
      final operation = value1 > value2;
    ...
    test(
        'should return false when comparing negative zero to positive Decimal zero',
        () {
      final value1 = Decimal(value: '-0.0', precision: 2, scale: 1);
      final value2 = Decimal(value: '0.0', precision: 2, scale: 1);
      final operation = value1 > value2;
    ...
    test(
        'should return false when comparing negative zero to positive Numeric zero',
        () {
      final value1 = Decimal(value: '-0.0', precision: 2, scale: 1);
      final value2 = Numeric(value: '0.0', precision: 2, scale: 1);
      final operation = value1 > value2;
