...
//
  group('positive subtraction', () {
    test('should correctly subtract BigInteger', () {
      final value1 = Decimal(value: '30.3', precision: 3, scale: 1);
    ...
    test('should correctly subtract fractional Numeric', () {
      final value1 = Decimal(value: '50.3', precision: 3, scale: 1);
    ...
    test('should correctly subtract Numeric with negative scale', () {
      final value1 = Decimal(value: '1950.3', precision: 5, scale: 1);
...
//
  group('mixed sign subtraction (negative + positive)', () {
    test('should correctly subtract BigInteger', () {
      final value1 = Decimal(value: '-20.3', precision: 3, scale: 1);
      final value2 = BigInteger(30);
...
// test group within this file.
  group('negative result tests (positive + positive)', () {
    ...
    test('should return negative value when subtracting fractional Numeric',
        () {
      final value1 = Decimal(value: '0.2', precision: 2, scale: 1);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
    ...
    test(
        ...
        () {
      final value1 = Decimal(value: '100.3', precision: 4, scale: 1);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
...
// [fractional arbitrary precision].
  group('zero result tests (positive + positive)', () {
    ...
    test('should return zero value when subtracting fractional Numeric', () {
      final value1 = Decimal(value: '0.35', precision: 3, scale: 2);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
...
// is 1, and they cannot store negative values.
  group('negative result tests (negative + negative)', () {
    ...
    test(
        'should return negative value when subtracting Numeric with negative scale',
        () {
      final value1 = Decimal(value: '-1900.3', precision: 5, scale: 1);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
...
// the minimum value constraint of [Serial types], which is 1.
  group('type casting', () {
    test('should return Decimal as result when subtracting BigInteger', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      final value2 = BigInteger(1);
      final operation = value1 - value2;
      expect(operation, isA<Decimal>());
    });

    test('should return Decimal as result when subtracting negative BigInteger',
        () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      final value2 = BigInteger(-1);
      final operation = value1 - value2;
    ...
    test('should return Decimal as result when subtracting Integer', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when subtracting negative Integer',
        () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      final value2 = Integer(-1);
      final operation = value1 - value2;
    ...
    test('should return Decimal as result when subtracting SmallInteger', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
    ...
    test(
        'should return Decimal as result when subtracting negative SmallInteger',
        () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      final value2 = SmallInteger(-1);
      final operation = value1 - value2;
    ...
    test('should return Decimal as result when subtracting BigSerial', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when subtracting Serial', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when subtracting SmallSerial', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when subtracting int primitive', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      const value2 = 1;
      final operation = value1 - value2;
      expect(operation, isA<Decimal>());
    ...
    test(
        'should return Decimal as result when subtracting negative int primitive',
        () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      const value2 = -1;
      final operation = value1 - value2;
    ...
    test('should return Decimal as result when subtracting double primitive',
        () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      const value2 = 1.5;
      final operation = value1 - value2;
    ...
    test(
        'should return Decimal as result when subtracting negative double primitive',
        () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      const value2 = -1.5;
      final operation = value1 - value2;
    ...
    test('should return Decimal as result when subtracting Real', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      final value2 = Real(1);
      final operation = value1 - value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when subtracting negative Real', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      final value2 = Real(-1);
      final operation = value1 - value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when subtracting DoublePrecision',
        () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
    ...
    test(
        'should return Decimal as result when subtracting negative DoublePrecision',
        () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      final value2 = DoublePrecision(-1);
      final operation = value1 - value2;
    ...
    test('should return Decimal as result when subtracting Numeric', () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when subtracting negative Numeric',
        () {
      final value1 = Decimal(value: '1.3', precision: 2, scale: 1);
      final value2 = Numeric(value: '-1', precision: 1, scale: 0);
      final operation = value1 - value2;
