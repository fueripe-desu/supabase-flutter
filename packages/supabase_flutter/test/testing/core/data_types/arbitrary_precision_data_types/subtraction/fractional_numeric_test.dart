...
//
  group('positive subtraction', () {
    test('should correctly subtract BigInteger', () {
      ...
      final expected = Numeric(value: '-19.7', precision: 3, scale: 1);
    ...
    test('should correctly subtract fractional double', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      const value2 = 20.5;
      final expected = Numeric(value: '-20.2', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract fractional Numeric', () {
      ...
      final expected = Numeric(value: '-0.05', precision: 2, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract Numeric with negative scale', () {
      ...
      final expected = Numeric(value: '-999.7', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// is 1, and they cannot store negative values.
  group('negative subtraction', () {
    test('should correctly subtract BigInteger', () {
      ...
      final expected = Numeric(value: '29.7', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract fractional double', () {
      final value1 = Numeric(value: '-0.3', precision: 1, scale: 1);
      const value2 = -30.5;
      final expected = Numeric(value: '30.2', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// is 1, and they cannot store negative values.
  group('mixed sign subtraction (positive + negative)', () {
    test('should correctly subtract BigInteger', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      final value2 = BigInteger(-30);
      final expected = Numeric(value: '30.3', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract fractional double', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      const value2 = -30.5;
      final expected = Numeric(value: '30.8', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract fractional Numeric', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      final value2 = Numeric(value: '-0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '0.65', precision: 2, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// separately in another test group within this file.
  group('positive result tests (positive + positive)', () {
    test('should return positive value when subtracting fractional double', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      const value2 = 0.1;
      final expected = Numeric(value: '0.2', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
        ...
        () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      final value2 = DoublePrecision(0.1);
      final expected = Numeric(value: '0.2', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return positive value when subtracting float Numeric', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      final value2 = Numeric(value: '0.1', precision: 2, scale: 1);
      final expected = Numeric(value: '0.2', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
        ...
        () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      final value2 = Numeric(value: '0.1');
      final expected = Numeric(value: '0.2', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return positive value when subtracting fractional Numeric',
        () {
      final value1 = Numeric(value: '0.35', precision: 2, scale: 2);
      final value2 = Numeric(value: '0.14', precision: 2, scale: 2);
      final expected = Numeric(value: '0.21', precision: 2, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return positive value when subtracting float Decimal', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      final value2 = Decimal(value: '0.1', precision: 2, scale: 1);
      final expected = Numeric(value: '0.2', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
        ...
        () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      final value2 = Decimal(value: '0.1');
      final expected = Numeric(value: '0.2', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// test group within this file.
  group('negative result tests (positive + positive)', () {
    test('should return negative value when subtracting BigInteger', () {
      ...
      final expected = Numeric(value: '-39.7', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return negative value when subtracting fractional double', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      const value2 = 40.5;
      final expected = Numeric(value: '-40.2', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return negative value when subtracting fractional Numeric',
        () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      final value2 = Numeric(value: '0.45', precision: 2, scale: 2);
    ...
    test('should return negative value when subtracting fractional Decimal',
        () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      final value2 = Decimal(value: '0.45', precision: 2, scale: 2);
      final expected = Numeric(value: '-0.15', precision: 2, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// [fractional arbitrary precision].
  group('zero result tests (positive + positive)', () {
    ...
    test('should return zero value when subtracting fractional Real', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
    ...
    test('should return zero value when subtracting fractional DoublePrecision',
        () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
    ...
    test('should return zero value when subtracting fractional Numeric', () {
      final value1 = Numeric(value: '0.35', precision: 2, scale: 2);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '0.00', precision: 2, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// [fractional arbitrary precision].
  group('zero result tests (negative + negative)', () {
    test('should return zero value when subtracting fractional double', () {
      final value1 = Numeric(value: '-0.3', precision: 1, scale: 1);
      const value2 = -0.3;
      final expected = Numeric(value: '0.0', precision: 2, scale: 1);
      final operation = value1 - value2;
    ...
    test('should return zero value when subtracting fractional Numeric', () {
      final value1 = Numeric(value: '-0.35', precision: 2, scale: 2);
      final value2 = Numeric(value: '-0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '0.0', precision: 2, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// as it is uncommon to set a fractional value precisely to '0.0'.
  group('zero cases', () {
    test('should retain positive sign when subtracting BigInteger', () {
      ...
      final expected = Numeric(value: '0.3', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// the minimum value constraint of [Serial types], which is 1.
  ...
  group('fractional promotion (negative + negative)', () {
    test(
      ...
      final expected = Numeric(value: '-1.2', precision: 2, scale: 1);
      final operation = value1 - value2;
      print(operation.toDetailedString());
      expect(operation.identicalTo(expected), true);
    });
