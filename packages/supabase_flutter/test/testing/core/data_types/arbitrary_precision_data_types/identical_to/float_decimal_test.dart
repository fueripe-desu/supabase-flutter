...
void main() {
  group('positive comparison', () {
    test('should return true if other has same type and value', () {
      final value1 = Decimal(value: '20.0', precision: 3, scale: 1);
      final value2 = Decimal(value: '20.0', precision: 3, scale: 1);
    ...
    test(
      ...
      final value2 = Decimal(value: '20.7', precision: 3, scale: 1);
