...
void main() {
  test('should work correctly with positive base and exponent', () {
    final baseValue = Numeric(value: '3');
    const exponent = 4;
    final expected = Numeric(value: '81', precision: 2, scale: 0);
    final operation = baseValue.pow(exponent);
    expect(operation.identicalTo(expected), true);
  });

  test('should work correctly with zero base and positive exponent', () {
    final baseValue = Numeric(value: '0');
    const exponent = 4;
  ...
  test('should work correctly with negative base and positive odd exponent',
      () {
    final baseValue = Numeric(value: '-2');
    const exponent = 3;
    final expected = Numeric(value: '-8', precision: 1, scale: 0);
    final operation = baseValue.pow(exponent);
    expect(operation.identicalTo(expected), true);
  });
  ...
  test('should work correctly with negative base and positive even exponent',
    ...
    final baseValue = Numeric(value: '-2');
    const exponent = 4;
    final expected = Numeric(value: '16', precision: 2, scale: 0);
    final operation = baseValue.pow(exponent);
    expect(operation.identicalTo(expected), true);
  });

  test('should throw work correctly with positive base and negative exponent',
      () {
    final baseValue = Numeric(value: '2');
    const exponent = -1;
  ...
  test(
      'should throw work correctly with negative base and negative odd exponent',
      () {
    final baseValue = Numeric(value: '2');
    const exponent = -3;
  ...
  test(
      'should throw work correctly with negative base and negative even exponent',
      () {
    final baseValue = Numeric(value: '2');
    const exponent = -4;
  ...
  test('should return itself if exponent is 1', () {
    final baseValue = Numeric(value: '27');
    const exponent = 1;
    final expected = Numeric(value: '27', precision: 2, scale: 0);
    final operation = baseValue.pow(exponent);
    expect(operation.identicalTo(expected), true);
  });
  ...
  test('should always return 1 if base is 1', () {
    final baseValue = Numeric(value: '1');
    const exponent = 4;
    final expected = Numeric(value: '1', precision: 1, scale: 0);
    final operation = baseValue.pow(exponent);
    expect(operation.identicalTo(expected), true);
