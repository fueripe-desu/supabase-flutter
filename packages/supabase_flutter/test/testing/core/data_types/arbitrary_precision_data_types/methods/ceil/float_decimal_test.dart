...
void main() {
  test('should work correctly with positive values', () {
    final value = Decimal(value: '3.2', precision: 2, scale: 1);
  ...
  test('should work correctly with negative values', () {
    final value = Decimal(value: '-3.7', precision: 2, scale: 1);
  ...
  test('should return itself if value is a negative whole number', () {
    final value = Decimal(value: '-2.0', precision: 2, scale: 1);
  ...
  test('should correctly handle fractionally small near-zero positive value',
      () {
    final value = Decimal(value: '0.00000000000001', precision: 15, scale: 14);
  ...
  test('should correctly handle positive numbers very close to an integer', () {
    final value = Decimal(value: '2.99999999999999', precision: 15, scale: 14);
    final expected = Decimal(
  ...
  test('should correctly handle positive values with small fractional part',
      () {
    final value = Decimal(value: '1.00000000000001', precision: 15, scale: 14);
    final expected = Decimal(
      value: '2.00000000000000',
      precision: 15,
      scale: 14,
  ...
  test('should work when given a scale', () {
    final value = Decimal(value: '3.1415', precision: 5, scale: 4);
    final expected = Decimal(value: '3.15', precision: 3, scale: 2);
