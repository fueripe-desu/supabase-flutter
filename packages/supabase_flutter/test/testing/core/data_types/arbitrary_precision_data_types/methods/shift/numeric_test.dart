...
void main() {
  test('should shift the decimal point to the right if input is positive', () {
    final value = Numeric(value: '312.9873249', precision: 10, scale: 7);
    final expected = Numeric(value: '31298.73249', precision: 10, scale: 5);
  ...
  test(
      ...
      () {
    final value = Numeric(value: '3.5', precision: 2, scale: 1);
    // 35 because it would become 35. after shifiting, so the point is removed
    final expected = Numeric(value: '35', precision: 2, scale: 0);
  ...
  test(
      ...
      () {
    final value = Numeric(value: '3.5', precision: 2, scale: 1);
    final expected = Numeric(value: '3500', precision: 4, scale: 0);
  ...
  test('should shift the decimal point to the left if input is negative', () {
    final value = Numeric(value: '312.9873249', precision: 10, scale: 7);
    final expected = Numeric(value: '3.129873249', precision: 10, scale: 9);
    final operation = value.shift(-2);
    expect(operation.identicalTo(expected), true);
  });
  ...
  test(
    ...
    final expected = Numeric(value: '0.35', precision: 3, scale: 2);
    final operation = value.shift(-1);
    expect(operation.identicalTo(expected), true);
  });

  test('should add 0s to the right of an integer if input is positive', () {
    final value = Numeric(value: '30', precision: 2, scale: 0);
    final expected = Numeric(value: '30000', precision: 5, scale: 0);
    final operation = value.shift(3);
    expect(operation.identicalTo(expected), true);
  });

  test('should remove 0s on the left of an integer if input is negative', () {
    final value = Numeric(value: '300', precision: 3, scale: 0);
  ...
  test(
      ...
      () {
    final value = Numeric(value: '312', precision: 3, scale: 0);
    final expected = Numeric(value: '3.12', precision: 3, scale: 2);
    final operation = value.shift(-2);
    expect(operation.identicalTo(expected), true);
  });
  ...
  test(
      ...
      () {
    final value = Numeric(value: '300', precision: 3, scale: 0);
    final expected = Numeric(value: '0.03', precision: 3, scale: 2);
    final operation = value.shift(-4);
    expect(operation.identicalTo(expected), true);
  });

  test('should shift correctly fractional values', () {
    final value = Numeric(value: '0.323', precision: 3, scale: 3);
    final expected = Numeric(value: '3.23', precision: 3, scale: 2);
    final operation = value.shift(1);
    expect(operation.identicalTo(expected), true);
  });
  ...
  test('should shift correctly negative scale values', () {
    ...
    final expected = Numeric(value: '300', precision: 3, scale: 0);
    final operation = value.shift(1);
    expect(operation.identicalTo(expected), true);
  });
}
