...
// Numeric(value: '1349') -> Unconstrained integer Numeric with the value '1349'
  group('positive multiplication', () {
    test('should correctly multiply BigInteger', () {
      final value1 = Decimal(value: '20.5', precision: 3, scale: 1);
      final value2 = BigInteger(30);
      final expected = Decimal(value: '615.0', precision: 4, scale: 1);
    ...
    test('should correctly multiply integer-valued double', () {
      final value1 = Decimal(value: '20.5', precision: 3, scale: 1);
      const value2 = 30.0;
      final expected = Decimal(value: '615.00', precision: 5, scale: 2);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply Numeric with negative scale', () {
      ...
      final expected = Decimal(value: '20500.0', precision: 6, scale: 1);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   Numeric(value: '1349') -> Unconstrained integer Numeric with the value '1349'
  group('mixed sign multiplication (positive + negative)', () {
    ...
    test('should correctly multiply Decimal with negative scale', () {
      final value1 = Decimal(value: '20.5', precision: 3, scale: 1);
      final value2 = Decimal(value: '-1231', precision: 4, scale: -3);
      final expected = Decimal(value: '-20500', precision: 6, scale: 1);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// are excluded as they do not commonly represent exact zeros (0.0).
  group('zero cases', () {
    ...
    test('should retain positive sign when multiplying double', () {
      final value1 = Decimal(value: '20.5', precision: 3, scale: 1);
      const value2 = 0.0;
      final expected = Decimal(value: '0.00', precision: 3, scale: 2);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
...
// the minimum value requirement of [Serial types], which is 1.
  group('type casting', () {
    test('should return Decimal as result when multiplying BigInteger', () {
    ...
    test('should return Decimal as result when multiplying negative BigInteger',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = BigInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return Decimal as result when multiplying Integer', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when multiplying negative Integer',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Integer(-1);
      final operation = value1 * value2;
    ...
    test('should return Decimal as result when multiplying SmallInteger', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
    ...
    test(
        'should return Decimal as result when multiplying negative SmallInteger',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = SmallInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return Decimal as result when multiplying BigSerial', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when multiplying Serial', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when multiplying SmallSerial', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when multiplying int primitive', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      const value2 = 1;
      final operation = value1 * value2;
      expect(operation, isA<Decimal>());
    ...
    test(
        'should return Decimal as result when multiplying negative int primitive',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      const value2 = -1;
      final operation = value1 * value2;
    ...
    test('should return Decimal as result when multiplying double primitive',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      const value2 = 1.5;
      final operation = value1 * value2;
    ...
    test(
        'should return Decimal as result when multiplying negative double primitive',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      const value2 = -1.5;
      final operation = value1 * value2;
    ...
    test('should return Decimal as result when multiplying Real', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Real(1);
      final operation = value1 * value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when multiplying negative Real', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Real(-1);
      final operation = value1 * value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when multiplying DoublePrecision',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
    ...
    test(
        'should return Decimal as result when multiplying negative DoublePrecision',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = DoublePrecision(-1);
      final operation = value1 * value2;
    ...
    test('should return Decimal as result when multiplying Numeric', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
    ...
    test('should return Decimal as result when multiplying negative Numeric',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Numeric(value: '-1', precision: 1, scale: 0);
      final operation = value1 * value2;
