...
//   Numeric(value: '1349') -> [Unconstrained int Numeric] with the {value} of 1349
  group('mixed sign addition (negative + positive)', () {
    ...
    test('should correctly add integer-valued Real', () {
      final value1 = Numeric(value: '-50.5', precision: 3, scale: 1);
      final value2 = Real(30.0);
...
// rather than data type integrity, which is assessed in a separate test group.
  group('positive result tests (negative + positive)', () {
    ...
    test('should return positive value when adding Numeric with negative scale',
        () {
      final value1 = Numeric(value: '-500.3', precision: 4, scale: 1);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
...
// which is 1.
  group('type casting', () {
    test('should return Numeric as result when adding BigInteger', () {
    ...
    test('should return Numeric as result when adding negative BigInteger', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      final value2 = BigInteger(-1);
      final operation = value1 + value2;
      expect(operation, isA<Numeric>());
    ...
    test('should return Numeric as result when adding Integer', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Numeric as result when adding negative Integer', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      final value2 = Integer(-1);
      final operation = value1 + value2;
      expect(operation, isA<Numeric>());
    ...
    test('should return Numeric as result when adding SmallInteger', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Numeric as result when adding negative SmallInteger',
        () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      final value2 = SmallInteger(-1);
      final operation = value1 + value2;
    ...
    test('should return Numeric as result when adding BigSerial', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Numeric as result when adding Serial', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Numeric as result when adding SmallSerial', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Numeric as result when adding int primitive', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      const value2 = 1;
      final operation = value1 + value2;
      expect(operation, isA<Numeric>());
    ...
    test('should return Numeric as result when adding negative int primitive',
        () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      const value2 = -1;
      final operation = value1 + value2;
    ...
    test('should return Numeric as result when adding double primitive', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      const value2 = 1.5;
      final operation = value1 + value2;
      expect(operation, isA<Numeric>());
    ...
    test(
        'should return Numeric as result when adding negative double primitive',
        () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      const value2 = -1.5;
      final operation = value1 + value2;
    ...
    test('should return Numeric as result when adding Real', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      final value2 = Real(1);
      final operation = value1 + value2;
      expect(operation, isA<Numeric>());
    ...
    test('should return Numeric as result when adding negative Real', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      final value2 = Real(-1);
      final operation = value1 + value2;
      expect(operation, isA<Numeric>());
    ...
    test('should return Numeric as result when adding DoublePrecision', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Numeric as result when adding negative DoublePrecision',
        () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      final value2 = DoublePrecision(-1);
      final operation = value1 + value2;
    ...
    test('should return Numeric as result when adding Decimal', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
    ...
    test('should return Numeric as result when adding negative Decimal', () {
      final value1 = Numeric(value: '1.3', precision: 2, scale: 1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 + value2;
      expect(operation, isA<Numeric>());
