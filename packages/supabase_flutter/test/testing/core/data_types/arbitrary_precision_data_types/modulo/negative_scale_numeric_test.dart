...
//   Numeric(value: '1349') -> Unconstrained int Numeric with value '1349'
  group('positive modulo', () {
    ...
    test('should correctly perform modulo with Numeric with negative scale',
        () {
      final value1 = Numeric(value: '3121', precision: 4, scale: -2);
...
//   fractional divisions.
  group('integer modulo (fractional)', () {
    test('should correctly perform modulo with BigInteger', () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
...
// is zero. If, instead, the second operand were zero, it would lead to an error.
  group('zero modulo by non-zero (zero + positive)', () {
    test('should return zero if performing modulo by BigInteger', () {
      final value1 = Numeric(value: '14', precision: 2, scale: -3);
...
//   minimum {value} of [Serial types], which is 1.
  group('type casting', () {
    test('should return Numeric as result when performing modulo by BigInteger',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = BigInteger(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by negative BigInteger',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = BigInteger(-1);
      final operation = value1 % value2;
    ...
    test('should return Numeric as result when performing modulo by Integer',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = Integer(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by negative Integer',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = Integer(-1);
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by SmallInteger',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = SmallInteger(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by negative SmallInteger',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = SmallInteger(-1);
      final operation = value1 % value2;
    ...
    test('should return Numeric as result when performing modulo by BigSerial',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = BigSerial(1);
      final operation = value1 % value2;
    ...
    test('should return Numeric as result when performing modulo by Serial',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = Serial(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by SmallSerial',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = SmallSerial(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by int primitive',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      const value2 = 1;
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by negative int primitive',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      const value2 = -1;
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by double primitive',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      const value2 = 1.5;
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by negative double primitive',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      const value2 = -1.5;
      final operation = value1 % value2;
    ...
    test('should return Numeric as result when performing modulo by Real', () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = Real(1);
      final operation = value1 % value2;
      expect(operation, isA<Numeric>());
    ...
    test(
        'should return Numeric as result when performing modulo by negative Real',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = Real(-1);
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by DoublePrecision',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = DoublePrecision(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by negative DoublePrecision',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = DoublePrecision(-1);
      final operation = value1 % value2;
    ...
    test('should return Numeric as result when performing modulo by Decimal',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 % value2;
    ...
    test(
        'should return Numeric as result when performing modulo by negative Decimal',
        () {
      final value1 = Numeric(value: '14', precision: 2, scale: -1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 % value2;
