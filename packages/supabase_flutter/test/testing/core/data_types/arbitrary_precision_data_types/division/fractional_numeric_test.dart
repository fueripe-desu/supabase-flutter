...
// Numeric(value: '1349') -> Unconstrained int Numeric with value '1349'
  group('positive division', () {
    test('should correctly divide BigInteger', () {
      ...
      final expected = Numeric(value: '0.15', precision: 21, scale: 20);
    ...
    test('should correctly divide fractional double', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      const value2 = 2.5;
      final expected = Numeric(value: '0.12', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide fractional Numeric', () {
      ...
      final expected = Numeric(value: '0.6', precision: 20, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide Numeric with negative scale', () {
      ...
      final expected = Numeric(value: '0.0003', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   [floating point types].
  group('integer-valued floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      ...
      const value2 = 2.0;
      final expected = Numeric(value: '0.3', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   outcome.
  group('fractional only floating point division (exact)', () {
    test('should correctly divide double primitive', () {
      final value1 = Numeric(value: '0.6', precision: 1, scale: 1);
      const value2 = 0.3;
      final expected = Numeric(value: '2', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   of an integer by such a floating point number results in a fractional outcome.
  group('fractional only floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = Numeric(value: '0.3', precision: 1, scale: 1);
      const value2 = 0.5;
      final expected = Numeric(value: '0.6', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   ensures consistency across tests involving [Serial types].
  ...
  group('fractional promotion (positive + positive)', () {
    test(
        ...
        () {
      final value1 = Numeric(value: '0.8', precision: 1, scale: 1);
      final value2 = Numeric(value: '0.2', precision: 1, scale: 1);
      final expected = Numeric(value: '4.0', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
