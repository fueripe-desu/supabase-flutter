...
// Numeric(value: '1349') -> Unconstrained int Numeric with value '1349'
  group('positive division', () {
    test('should correctly divide BigInteger', () {
      final value1 = Decimal(value: '30.5', precision: 3, scale: 1);
    ...
    test('should correctly divide Numeric with negative scale', () {
      final value1 = Decimal(value: '3000.5', precision: 5, scale: 1);
...
//   and [Integer types].
  group('integer division (fractional)', () {
    test('should correctly divide BigInteger', () {
      final value1 = Decimal(value: '0.75', precision: 3, scale: 2);
      final value2 = BigInteger(2);
...
//   [floating point types].
  group('integer-valued floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = Decimal(value: '5.5', precision: 2, scale: 1);
      const value2 = 2.0;
...
//   by a floating point number with decimals results in an exact integer outcome.
  group('fractional floating point division (exact)', () {
    test('should correctly divide double primitive', () {
      final value1 = Decimal(value: '7.5', precision: 2, scale: 1);
      const value2 = 2.5;
...
//   by a floating point number results in a fractional outcome.
  group('fractional floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = Decimal(value: '6.5', precision: 2, scale: 1);
      const value2 = 2.5;
...
//   outcome.
  group('fractional only floating point division (exact)', () {
    test('should correctly divide double primitive', () {
      final value1 = Decimal(value: '8.5', precision: 2, scale: 1);
      const value2 = 0.5;
...
//   of an integer by such a floating point number results in a fractional outcome.
  group('fractional only floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = Decimal(value: '5.4', precision: 2, scale: 1);
      const value2 = 0.3;
...
//   ensures consistency across tests involving [Serial types].
  group('type casting', () {
    test('should return Decimal as result when dividing BigInteger', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = BigInteger(1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    });

    test('should return Decimal as result when dividing negative BigInteger',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = BigInteger(-1);
      final operation = value1 / value2;
    ...
    test('should return Decimal as result when dividing Integer', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Integer(1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing negative Integer', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Integer(-1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing SmallInteger', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = SmallInteger(1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing negative SmallInteger',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = SmallInteger(-1);
      final operation = value1 / value2;
    ...
    test('should return Decimal as result when dividing BigSerial', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = BigSerial(1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing Serial', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Serial(1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing SmallSerial', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = SmallSerial(1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing int primitive', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      const value2 = 1;
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing negative int primitive',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      const value2 = -1;
      final operation = value1 / value2;
    ...
    test('should return Decimal as result when dividing double primitive', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      const value2 = 1.5;
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test(
        'should return Decimal as result when dividing negative double primitive',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      const value2 = -1.5;
      final operation = value1 / value2;
    ...
    test('should return Decimal as result when dividing Real', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Real(1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing negative Real', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Real(-1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing DoublePrecision', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = DoublePrecision(1);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test(
        'should return Decimal as result when dividing negative DoublePrecision',
        () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = DoublePrecision(-1);
      final operation = value1 / value2;
    ...
    test('should return Decimal as result when dividing Numeric', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Numeric(value: '1', precision: 1, scale: 0);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
    ...
    test('should return Decimal as result when dividing negative Numeric', () {
      final value1 = Decimal(value: '1.5', precision: 2, scale: 1);
      final value2 = Numeric(value: '-1', precision: 1, scale: 0);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
