...
void main() {
  group('toString() method', () {
    test('should cast correctly a floating point value', () {
      final value = Numeric(value: '3.14', precision: 3, scale: 2);
    ...
    test('should cast correctly if scale is greater than the actual value', () {
      final value = Numeric(value: '3.14', precision: 5, scale: 4);
    ...
    test(
        ...
        () {
      final value = Numeric(value: '3', precision: 3, scale: 2);
    ...
    test(
        ...
        () {
      final value = Numeric(value: '3.14', precision: 5, scale: 2);
      expect(value.toString() == '3.14', true);
    });
