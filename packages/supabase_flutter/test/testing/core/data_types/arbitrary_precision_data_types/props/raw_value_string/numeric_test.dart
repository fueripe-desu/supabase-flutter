...
void main() {
  ...
  test(
    ...
    final numeric = Numeric(value: '1322.76598190', precision: 3, scale: -2);
  ...
  test('should round to 0 if the negative scale is too great', () {
    ...
    final numeric = Numeric(value: '1322.76598190', precision: 3, scale: -10);
    expect(numeric.rawValueString, '0');
  });

  test('should display correctly positive fractional values', () {
    final numeric = Numeric(value: '0.34', precision: 2, scale: 2);
