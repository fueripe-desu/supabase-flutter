...
//   Numeric(value: '1349') -> Unconstrained int Numeric with the value of '1349'
  group('positive division', () {
    test('should correctly divide BigInteger', () {
      ...
      final expected = Money(r'$15.00', overrideCurrency: Currencies.usd);
    ...
    test('should correctly divide fractional double', () {
      final value1 = Money(r'$30.00', overrideCurrency: Currencies.usd);
      const value2 = 2.5;
      final expected = Money(r'$12.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide fractional Numeric', () {
      ...
      final expected = Money(r'$100.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide Numeric with negative scale', () {
      final value1 = Money(r'$3000.00', overrideCurrency: Currencies.usd);
...
//   where the outcomes must be exact integers without any fractional components.
  group('integer division (exact)', () {
    test('should correctly divide BigInteger', () {
      ...
      final value2 = BigInteger(2);
      final expected = Money(r'$25.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   fractional components discarded.
  group('integer division (fractional)', () {
    test('should correctly divide BigInteger', () {
      final value1 = Money(r'$5.00', overrideCurrency: Currencies.usd);
      final value2 = BigInteger(2);
      final expected = Money(r'$2.50', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   in this group, ensuring they behave as expected under integer division rules.
  group('fractional floating point division (exact)', () {
    test('should correctly divide double primitive', () {
      final value1 = Money(r'$6.00', overrideCurrency: Currencies.usd);
      const value2 = 1.5;
      final expected = Money(r'$4.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   integer division rules.
  group('fractional floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = Money(r'$7.00', overrideCurrency: Currencies.usd);
      const value2 = 1.5;
      final expected = Money(r'$4.66', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   behave correctly under integer division rules.
  group('fractional only floating point division (exact)', () {
    test('should correctly divide double primitive', () {
      final value1 = Money(r'$4.00', overrideCurrency: Currencies.usd);
      const value2 = 0.5;
      final expected = Money(r'$8.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   behave as expected under integer division rules.
  group('fractional only floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = Money(r'$8.00', overrideCurrency: Currencies.usd);
      const value2 = 0.3;
      final expected = Money(r'$26.66', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   cannot represent an [Integer type].
  group('division by one', () {
    test('should return itself when dividing by BigInteger one', () {
      ...
      final expected = Money(r'$30.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
