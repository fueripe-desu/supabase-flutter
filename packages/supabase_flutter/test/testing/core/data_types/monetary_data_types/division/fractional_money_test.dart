...
// Numeric(value: '1349') -> Unconstrained int Numeric with value '1349'
  group('positive division', () {
    test('should correctly divide BigInteger', () {
      final value1 = Money(r'$30.50', overrideCurrency: Currencies.usd);
      final value2 = BigInteger(2);
      final expected = Money(r'$15.25', overrideCurrency: Currencies.usd);
    ...
    test('should correctly divide fractional double', () {
      final value1 = Money(r'$30.50', overrideCurrency: Currencies.usd);
      const value2 = 2.5;
      final expected = Money(r'$12.20', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide fractional Numeric', () {
      final value1 = Money(r'$30.30', overrideCurrency: Currencies.usd);
      final value2 = Numeric(value: '0.3', precision: 1, scale: 1);
      final expected = Money(r'$101.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide Numeric with negative scale', () {
      final value1 = Money(r'$3000.50', overrideCurrency: Currencies.usd);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Money(r'$3.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
// Numeric(value: '1349') -> Unconstrained int Numeric with value '1349'
  group('negative division', () {
    ...
    // {scale}.
    test('should correctly divide Numeric with negative scale', () {
      final value1 = Money(r'-$3.00', overrideCurrency: Currencies.usd);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
...
//   and [Integer types].
  group('integer division (fractional)', () {
    test('should correctly divide BigInteger', () {
      final value1 = Money(r'$0.75', overrideCurrency: Currencies.usd);
      final value2 = BigInteger(2);
      final expected = Money(r'$0.37', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   [floating point types].
  group('integer-valued floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = Money(r'$5.50', overrideCurrency: Currencies.usd);
      const value2 = 2.0;
      final expected = Money(r'$2.75', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   by a floating point number with decimals results in an exact integer outcome.
  group('fractional floating point division (exact)', () {
    test('should correctly divide double primitive', () {
      final value1 = Money(r'$7.50', overrideCurrency: Currencies.usd);
      const value2 = 2.5;
      final expected = Money(r'$3.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
...
//   by a floating point number results in a fractional outcome.
  group('fractional floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = Money(r'$6.50', overrideCurrency: Currencies.usd);
      const value2 = 2.5;
      final expected = Money(r'$2.60', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   outcome.
  group('fractional only floating point division (exact)', () {
    test('should correctly divide double primitive', () {
      final value1 = Money(r'$8.50', overrideCurrency: Currencies.usd);
      const value2 = 0.5;
      final expected = Money(r'$17.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   of an integer by such a floating point number results in a fractional outcome.
  group('fractional only floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = Money(r'$5.40', overrideCurrency: Currencies.usd);
      const value2 = 0.3;
      final expected = Money(r'$18.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
// when a number is divided by itself.
  group('division by itself (positive)', () {
    test('should return one when dividing by double primitive', () {
      final value1 = Money(r'$30.50', overrideCurrency: Currencies.usd);
      const value2 = 30.5;
      final expected = Money(r'$1.00', overrideCurrency: Currencies.usd);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return one when dividing by fractional Numeric', () {
      final value1 = Money(r'$0.35', overrideCurrency: Currencies.usd);
