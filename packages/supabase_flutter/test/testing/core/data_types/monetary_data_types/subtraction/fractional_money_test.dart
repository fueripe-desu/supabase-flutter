...
void main() {
  ...
  test('should correctly perform mixed sign subtraction (positive + negative)',
      () {
    final value1 = Money(r'$50.37', overrideCurrency: Currencies.usd);
    final value2 = Money(r'-$30.12', overrideCurrency: Currencies.usd);
    final expected = Money(r'$80.49', overrideCurrency: Currencies.usd);
    final operation = value1 - value2;
    expect(operation.identicalTo(expected), true);
  });
  ...
  test('should correctly perform mixed sign subtraction (negative + positive)',
    ...
    final value2 = Money(r'$30.12', overrideCurrency: Currencies.usd);
    final expected = Money(r'-$50.49', overrideCurrency: Currencies.usd);
    final operation = value1 - value2;
    expect(operation.identicalTo(expected), true);
  });

  test('should return positive value (positive + positive)', () {
    final value1 = Money(r'$40.37', overrideCurrency: Currencies.usd);
    final value2 = Money(r'$30.12', overrideCurrency: Currencies.usd);
    final expected = Money(r'$10.25', overrideCurrency: Currencies.usd);
    final operation = value1 - value2;
    expect(operation.identicalTo(expected), true);
  ...
  test('should return negative value (positive + positive)', () {
    final value1 = Money(r'$30.37', overrideCurrency: Currencies.usd);
    final value2 = Money(r'$40.12', overrideCurrency: Currencies.usd);
  ...
  test('should return zero (positive + positive)', () {
    final value1 = Money(r'$40.37', overrideCurrency: Currencies.usd);
    final value2 = Money(r'$40.37', overrideCurrency: Currencies.usd);
  ...
  test('should return positive value (positive + negative)', () {
    final value1 = Money(r'$40.37', overrideCurrency: Currencies.usd);
    final value2 = Money(r'-$30.12', overrideCurrency: Currencies.usd);
    final expected = Money(r'$70.49', overrideCurrency: Currencies.usd);
    final operation = value1 - value2;
    expect(operation.identicalTo(expected), true);
  });
