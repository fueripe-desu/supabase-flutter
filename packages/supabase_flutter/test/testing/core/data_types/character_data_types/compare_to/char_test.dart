...
void main() {
  group('string comparison (greater)', () {
    test('should return 1 when comparing to string primitive', () {
      final value1 = Char('apple', length: 5);
      const value2 = 'ant';
      final operation = value1.compareTo(value2);
      expect(operation, 1);
    });

    test('should return 1 when comparing to Char', () {
      final value1 = Char('apple', length: 5);
    ...
    test('should return 1 when comparing to VarChar', () {
      final value1 = Char('apple', length: 5);
    ...
    test('should return 1 when comparing to Text', () {
      final value1 = Char('apple', length: 5);
    ...
    test('should return 1 when comparing to integer-valued double', () {
      final value1 = Char('20.0', length: 4);
      const value2 = 10.0;
      final operation = value1.compareTo(value2);
      expect(operation, 1);
    });
  ...
  group('string comparison (less)', () {
    test('should return -1 when comparing to string primitive', () {
      final value1 = Char('cat', length: 3);
      const value2 = 'dog';
      final operation = value1.compareTo(value2);
      expect(operation, -1);
    });
  ...
  group('string comparison (equal)', () {
    test('should return 0 when comparing to string primitive', () {
      final value1 = Char('hello', length: 5);
      const value2 = 'hello';
      final operation = value1.compareTo(value2);
      expect(operation, 0);
    });

    test('should return 0 when comparing to Char', () {
      final value1 = Char('hello', length: 5);
    ...
    test('should return 0 when comparing to VarChar', () {
      final value1 = Char('hello', length: 5);
    ...
    test('should return 0 when comparing to Text', () {
      final value1 = Char('hello', length: 5);
