...
// is 1, and they cannot store negative values.
  group('mixed sign addition (positive + negative)', () {
    ...
    test('should correctly add a fractional DoublePrecision', () {
      final value1 = DoublePrecision(50.3);
      final value2 = DoublePrecision(-30.5);
      final expected = DoublePrecision(19.7);
      final operation = (value1 + value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly add Numeric with negative scale', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
      final expected = Numeric(value: '-949.7', precision: 4, scale: 1);
      final operation = value1 + value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly add Decimal with negative scale', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Decimal(value: '-1231', precision: 4, scale: -3);
      final expected = Decimal(value: '-949.7', precision: 4, scale: 1);
      final operation = value1 + value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
//   Numeric(value: '1349') -> [Unconstrained int Numeric] with the {value} of 1349
  group('mixed sign addition (negative + positive)', () {
    ...
    test('should correctly add integer-valued DoublePrecision', () {
      final value1 = DoublePrecision(-50.5);
      final value2 = DoublePrecision(30.0);
...
// is 1, and they cannot store negative values.
  group('positive result tests (positive + negative)', () {
    ...
    test('should return positive value when adding fractional Numeric', () {
      final value1 = DoublePrecision(40.3);
      final value2 = Numeric(value: '-0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '39.95', precision: 4, scale: 2);
      final operation = value1 + value2;
      expect(operation.identicalTo(expected), true);
    });
...
// rather than data type integrity, which is assessed in a separate test group.
  group('positive result tests (negative + positive)', () {
    ...
    test('should return positive value when adding Numeric with negative scale',
        () {
      final value1 = DoublePrecision(-500.3);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '499.7', precision: 4, scale: 1);
      final operation = value1 + value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return positive value when adding Decimal with negative scale',
      ...
      final value1 = DoublePrecision(-500.3);
      final value2 = Decimal(value: '1231', precision: 4, scale: -3);
      final expected = Decimal(value: '499.7', precision: 4, scale: 1);
      final operation = value1 + value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// group within this file.
  group('negative result tests (negative + positive)', () {
    ...
    test('should return negative value when adding fractional Numeric', () {
      final value1 = DoublePrecision(-30.3);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '-29.95', precision: 4, scale: 2);
      final operation = value1 + value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return negative value when adding fractional Decimal', () {
      final value1 = DoublePrecision(-30.3);
      final value2 = Decimal(value: '0.35', precision: 2, scale: 2);
      final expected = Decimal(value: '-29.95', precision: 4, scale: 2);
      final operation = value1 + value2;
      expect(operation.identicalTo(expected), true);
    });
...
// [fractional arbitrary precision].
  group('zero result tests (positive + negative)', () {
    ...
    test('should return zero when adding fractional Numeric', () {
      ...
      final value2 = Numeric(value: '-0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '0', precision: 3, scale: 2);
      final operation = value1 + value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return zero when adding fractional Decimal', () {
      final value1 = DoublePrecision(0.35);
      final value2 = Decimal(value: '-0.35', precision: 2, scale: 2);
      final expected = Decimal(value: '0', precision: 3, scale: 2);
      final operation = value1 + value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// which is 1.
  group('type casting', () {
    test('should return DoublePrecision as result when adding BigInteger', () {
    ...
    test(
        'should return DoublePrecision as result when adding negative BigInteger',
        () {
      final value1 = DoublePrecision(1.3);
      final value2 = BigInteger(-1);
      final operation = value1 + value2;
    ...
    test('should return DoublePrecision as result when adding Integer', () {
      final value1 = DoublePrecision(1.3);
    ...
    test('should return DoublePrecision as result when adding negative Integer',
        () {
      final value1 = DoublePrecision(1.3);
      final value2 = Integer(-1);
      final operation = value1 + value2;
    ...
    test('should return DoublePrecision as result when adding SmallInteger',
        () {
      final value1 = DoublePrecision(1.3);
    ...
    test(
        'should return DoublePrecision as result when adding negative SmallInteger',
        () {
      final value1 = DoublePrecision(1.3);
      final value2 = SmallInteger(-1);
      final operation = value1 + value2;
    ...
    test('should return DoublePrecision as result when adding BigSerial', () {
      final value1 = DoublePrecision(1.3);
    ...
    test('should return DoublePrecision as result when adding Serial', () {
      final value1 = DoublePrecision(1.3);
    ...
    test('should return DoublePrecision as result when adding SmallSerial', () {
      final value1 = DoublePrecision(1.3);
    ...
    test('should return DoublePrecision as result when adding int primitive',
        () {
      final value1 = DoublePrecision(1.3);
      const value2 = 1;
      final operation = value1 + value2;
    ...
    test(
        'should return DoublePrecision as result when adding negative int primitive',
        () {
      final value1 = DoublePrecision(1.3);
      const value2 = -1;
      final operation = value1 + value2;
    ...
    test('should return DoublePrecision as result when adding double primitive',
        () {
      final value1 = DoublePrecision(1.3);
      const value2 = 1.5;
      final operation = value1 + value2;
    ...
    test(
        'should return DoublePrecision as result when adding negative double primitive',
        () {
      final value1 = DoublePrecision(1.3);
      const value2 = -1.5;
      final operation = value1 + value2;
    ...
    test('should return DoublePrecision as result when adding Real', () {
      final value1 = DoublePrecision(1.3);
      final value2 = Real(1);
      final operation = value1 + value2;
      expect(operation, isA<DoublePrecision>());
    ...
    test('should return DoublePrecision as result when adding negative Real',
        () {
      final value1 = DoublePrecision(1.3);
      final value2 = Real(-1);
      final operation = value1 + value2;
