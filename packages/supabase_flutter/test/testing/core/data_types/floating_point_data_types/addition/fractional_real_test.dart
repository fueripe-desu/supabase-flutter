...
// which is 1.
  group('type casting', () {
    test('should return Real as result when adding BigInteger', () {
    ...
    test('should return Real as result when adding negative BigInteger', () {
      final value1 = Real(1.3);
      final value2 = BigInteger(-1);
      final operation = value1 + value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when adding Integer', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when adding negative Integer', () {
      final value1 = Real(1.3);
      final value2 = Integer(-1);
      final operation = value1 + value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when adding SmallInteger', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when adding negative SmallInteger', () {
      final value1 = Real(1.3);
      final value2 = SmallInteger(-1);
      final operation = value1 + value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when adding BigSerial', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when adding Serial', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when adding SmallSerial', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when adding int primitive', () {
      final value1 = Real(1.3);
      const value2 = 1;
      final operation = value1 + value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when adding negative int primitive', () {
      final value1 = Real(1.3);
      const value2 = -1;
      final operation = value1 + value2;
      expect(operation, isA<Real>());
