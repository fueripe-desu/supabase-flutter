...
//   Numeric(value: '1349') -> Unconstrained int Numeric with value '1349'
  group('positive modulo', () {
    ...
    test('should correctly perform modulo with fractional double', () {
      final value1 = DoublePrecision(30.5);
      const value2 = 4.5;
      final expected = DoublePrecision(3.5);
      final operation = (value1 % value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly perform modulo with Numeric with negative scale',
        () {
      final value1 = DoublePrecision(3100.5);
...
//   fractional divisions.
  group('integer modulo (fractional)', () {
    test('should correctly perform modulo with BigInteger', () {
      ...
      final expected = DoublePrecision(1.5);
      final operation = (value1 % value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
...
//   results in fractional divisions.
  group('fractional only floating point modulo (fractional)', () {
    test('should correctly perform modulo with double primitive', () {
      final value1 = DoublePrecision(5.2);
      const value2 = 0.3;
...
//   minimum {value} of [Serial types], which is 1.
  group('type casting', () {
    ...
    test(
        'should return DoublePrecision as result when performing modulo by negative BigInteger',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = BigInteger(-1);
      final operation = value1 % value2;
    ...
    test(
        'should return DoublePrecision as result when performing modulo by negative Integer',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = Integer(-1);
      final operation = value1 % value2;
    ...
    test(
        'should return DoublePrecision as result when performing modulo by negative SmallInteger',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = SmallInteger(-1);
      final operation = value1 % value2;
    ...
    test(
        'should return DoublePrecision as result when performing modulo by negative int primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = -1;
      final operation = value1 % value2;
    ...
    test(
        'should return DoublePrecision as result when performing modulo by double primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = 1.5;
      final operation = value1 % value2;
    ...
    test(
        'should return DoublePrecision as result when performing modulo by negative double primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = -1.5;
      final operation = value1 % value2;
