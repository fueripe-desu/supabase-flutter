...
// Numeric(value: '1349') -> Unconstrained int Numeric with value '1349'
  group('positive division', () {
    test('should correctly divide BigInteger', () {
      final value1 = DoublePrecision(30.5);
      final value2 = BigInteger(2);
      final expected = DoublePrecision(15.25);
    ...
    test('should correctly divide fractional double', () {
      final value1 = DoublePrecision(30.5);
      const value2 = 2.5;
      final expected = DoublePrecision(12.2);
      final operation = (value1 / value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly divide Numeric with negative scale', () {
      final value1 = DoublePrecision(3000.5);
    ...
    test('should correctly divide int Decimal', () {
      ...
      final expected = Decimal(value: '15.25', precision: 22, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide float Decimal', () {
      ...
      final expected = Decimal(value: '12.2', precision: 22, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide fractional Decimal', () {
      ...
      final expected = Decimal(value: '101', precision: 23, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide Decimal with negative scale', () {
      ...
      final expected = Decimal(value: '3.0005', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
//   and [Integer types].
  group('integer division (fractional)', () {
    test('should correctly divide BigInteger', () {
      final value1 = DoublePrecision(0.75);
      final value2 = BigInteger(2);
      final expected = DoublePrecision(0.375);
      final operation = (value1 / value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly divide int Decimal', () {
      final value1 = DoublePrecision(0.75);
      final value2 = Decimal(value: '2', precision: 1, scale: 0);
      final expected = Decimal(value: '0.375', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   [floating point types].
  group('integer-valued floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = DoublePrecision(5.5);
      const value2 = 2.0;
      final expected = DoublePrecision(2.75);
      final operation = (value1 / value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly divide float Decimal', () {
      ...
      final expected = Decimal(value: '2.75', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   by a floating point number with decimals results in an exact integer outcome.
  group('fractional floating point division (exact)', () {
    test('should correctly divide double primitive', () {
      final value1 = DoublePrecision(7.5);
      const value2 = 2.5;
...
//   by a floating point number results in a fractional outcome.
  group('fractional floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = DoublePrecision(6.5);
      const value2 = 2.5;
      final expected = DoublePrecision(2.6);
      final operation = (value1 / value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly divide float Decimal', () {
      final value1 = DoublePrecision(6.5);
      final value2 = Decimal(value: '2.5', precision: 2, scale: 1);
      final expected = Decimal(value: '2.6', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   outcome.
  group('fractional only floating point division (exact)', () {
    test('should correctly divide double primitive', () {
      final value1 = DoublePrecision(8.5);
      const value2 = 0.5;
      final expected = DoublePrecision(17);
      final operation = (value1 / value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly divide fractional Decimal', () {
      ...
      final expected = Decimal(value: '17', precision: 22, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
//   of an integer by such a floating point number results in a fractional outcome.
  group('fractional only floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      final value1 = DoublePrecision(5.4);
      const value2 = 0.3;
      final expected = DoublePrecision(18);
      final operation = (value1 / value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly divide fractional Decimal', () {
      final value1 = DoublePrecision(5.4);
      final value2 = Decimal(value: '0.3', precision: 1, scale: 1);
      final expected = Decimal(value: '18', precision: 22, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
//   designed to represent pure integer values.
  group('division by one', () {
    test('should return itself when dividing by BigInteger one', () {
      ...
      final expected = DoublePrecision(30.5);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return itself when dividing by int Decimal one', () {
      ...
      final expected = Decimal(value: '30.5', precision: 22, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   ensures consistency across tests involving [Serial types].
  group('type casting', () {
    test('should return DoublePrecision as result when dividing BigInteger',
        () {
    ...
    test(
        'should return DoublePrecision as result when dividing negative BigInteger',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = BigInteger(-1);
      final operation = value1 / value2;
    ...
    test('should return DoublePrecision as result when dividing Integer', () {
      final value1 = DoublePrecision(1.5);
      final value2 = Integer(1);
      final operation = value1 / value2;
      expect(operation, isA<DoublePrecision>());
    ...
    test(
        'should return DoublePrecision as result when dividing negative Integer',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = Integer(-1);
      final operation = value1 / value2;
    ...
    test('should return DoublePrecision as result when dividing SmallInteger',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = SmallInteger(1);
      final operation = value1 / value2;
    ...
    test(
        'should return DoublePrecision as result when dividing negative SmallInteger',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = SmallInteger(-1);
      final operation = value1 / value2;
    ...
    test('should return DoublePrecision as result when dividing BigSerial', () {
      final value1 = DoublePrecision(1.5);
      final value2 = BigSerial(1);
      final operation = value1 / value2;
      expect(operation, isA<DoublePrecision>());
    ...
    test('should return DoublePrecision as result when dividing Serial', () {
      final value1 = DoublePrecision(1.5);
      final value2 = Serial(1);
      final operation = value1 / value2;
      expect(operation, isA<DoublePrecision>());
    ...
    test('should return DoublePrecision as result when dividing SmallSerial',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = SmallSerial(1);
      final operation = value1 / value2;
    ...
    test('should return DoublePrecision as result when dividing int primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = 1;
      final operation = value1 / value2;
    ...
    test(
        'should return DoublePrecision as result when dividing negative int primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = -1;
      final operation = value1 / value2;
    ...
    test(
        'should return DoublePrecision as result when dividing double primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = 1.5;
      final operation = value1 / value2;
    ...
    test(
        'should return DoublePrecision as result when dividing negative double primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = -1.5;
      final operation = value1 / value2;
    ...
    test('should return DoublePrecision as result when dividing Real', () {
      final value1 = DoublePrecision(1.5);
      final value2 = Real(1);
      final operation = value1 / value2;
      expect(operation, isA<DoublePrecision>());
    ...
    test('should return DoublePrecision as result when dividing negative Real',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = Real(-1);
      final operation = value1 / value2;
