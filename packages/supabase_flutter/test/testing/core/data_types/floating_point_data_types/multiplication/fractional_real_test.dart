...
// Numeric(value: '1349') -> Unconstrained integer Numeric with the value '1349'
  group('positive multiplication', () {
    test('should correctly multiply BigInteger', () {
      final value1 = Real(20.5);
      final value2 = BigInteger(30);
      final expected = Real(615);
...
// the minimum value requirement of [Serial types], which is 1.
  group('type casting', () {
    test('should return Real as result when multiplying BigInteger', () {
      final value1 = Real(1.5);
      final value2 = BigInteger(1);
      final operation = value1 * value2;
      expect(operation, isA<Real>());
    });

    test('should return Real as result when multiplying negative BigInteger',
        () {
      final value1 = Real(1.5);
      final value2 = BigInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return Real as result when multiplying Integer', () {
      final value1 = Real(1.5);
    ...
    test('should return Real as result when multiplying negative Integer', () {
      final value1 = Real(1.5);
      final value2 = Integer(-1);
      final operation = value1 * value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when multiplying SmallInteger', () {
      final value1 = Real(1.5);
    ...
    test('should return Real as result when multiplying negative SmallInteger',
        () {
      final value1 = Real(1.5);
      final value2 = SmallInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return Real as result when multiplying BigSerial', () {
      final value1 = Real(1.5);
    ...
    test('should return Real as result when multiplying Serial', () {
      final value1 = Real(1.5);
    ...
    test('should return Real as result when multiplying SmallSerial', () {
      final value1 = Real(1.5);
    ...
    test('should return Real as result when multiplying int primitive', () {
      final value1 = Real(1.5);
      const value2 = 1;
      final operation = value1 * value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when multiplying negative int primitive',
        () {
      final value1 = Real(1.5);
      const value2 = -1;
      final operation = value1 * value2;
