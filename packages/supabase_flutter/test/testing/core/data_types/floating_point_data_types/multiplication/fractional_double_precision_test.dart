...
// Numeric(value: '1349') -> Unconstrained integer Numeric with the value '1349'
  group('positive multiplication', () {
    test('should correctly multiply BigInteger', () {
      final value1 = DoublePrecision(20.5);
      final value2 = BigInteger(30);
      final expected = DoublePrecision(615);
    ...
    test('should correctly multiply fractional double', () {
      final value1 = DoublePrecision(20.5);
      const value2 = 30.5;
      final expected = DoublePrecision(625.25);
      final operation = (value1 * value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly multiply int Numeric', () {
      ...
      final expected = Numeric(value: '615', precision: 4, scale: 1);
    ...
    test('should correctly multiply float Numeric', () {
      ...
      final expected = Numeric(value: '625.25', precision: 5, scale: 2);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply fractional Numeric', () {
      ...
      final expected = Numeric(value: '7.175', precision: 4, scale: 3);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply Numeric with negative scale', () {
      final value1 = DoublePrecision(2.5);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '2500', precision: 5, scale: 1);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply int Decimal', () {
      ...
      final expected = Decimal(value: '615', precision: 4, scale: 1);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply float Decimal', () {
      ...
      final expected = Decimal(value: '625.25', precision: 5, scale: 2);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply fractional Decimal', () {
      ...
      final expected = Decimal(value: '7.175', precision: 4, scale: 3);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply Decimal with negative scale', () {
      ...
      final expected = Decimal(value: '2500', precision: 5, scale: 1);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// are excluded as they do not commonly represent exact zeros (0.0).
  group('zero cases', () {
    ...
    test('should retain positive sign when multiplying int Numeric', () {
      ...
      final expected = Numeric(value: '0', precision: 2, scale: 1);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should retain positive sign when multiplying int Decimal', () {
      ...
      final expected = Decimal(value: '0', precision: 2, scale: 1);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
...
// the minimum value requirement of [Serial types], which is 1.
  group('type casting', () {
    test('should return DoublePrecision as result when multiplying BigInteger',
        () {
      final value1 = DoublePrecision(1.5);
    ...
    test(
        'should return DoublePrecision as result when multiplying negative BigInteger',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = BigInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return DoublePrecision as result when multiplying Integer',
        () {
      final value1 = DoublePrecision(1.5);
    ...
    test(
        'should return DoublePrecision as result when multiplying negative Integer',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = Integer(-1);
      final operation = value1 * value2;
    ...
    test(
        'should return DoublePrecision as result when multiplying SmallInteger',
        () {
      final value1 = DoublePrecision(1.5);
    ...
    test(
        'should return DoublePrecision as result when multiplying negative SmallInteger',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = SmallInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return DoublePrecision as result when multiplying BigSerial',
        () {
      final value1 = DoublePrecision(1.5);
    ...
    test('should return DoublePrecision as result when multiplying Serial', () {
      final value1 = DoublePrecision(1.5);
    ...
    test('should return DoublePrecision as result when multiplying SmallSerial',
        () {
      final value1 = DoublePrecision(1.5);
    ...
    test(
        'should return DoublePrecision as result when multiplying int primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = 1;
      final operation = value1 * value2;
    ...
    test(
        'should return DoublePrecision as result when multiplying negative int primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = -1;
      final operation = value1 * value2;
    ...
    test(
        'should return DoublePrecision as result when multiplying double primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = 1.5;
      final operation = value1 * value2;
    ...
    test(
        'should return DoublePrecision as result when multiplying negative double primitive',
        () {
      final value1 = DoublePrecision(1.5);
      const value2 = -1.5;
      final operation = value1 * value2;
    ...
    test('should return DoublePrecision as result when multiplying Real', () {
      final value1 = DoublePrecision(1.5);
      final value2 = Real(1);
      final operation = value1 * value2;
      expect(operation, isA<DoublePrecision>());
    ...
    test(
        'should return DoublePrecision as result when multiplying negative Real',
        () {
      final value1 = DoublePrecision(1.5);
      final value2 = Real(-1);
      final operation = value1 * value2;
...
// test groups within this file.
  group('overflow and underflow errors', () {
    test('should throw RangeError if multiplying DoublePrecision overflows',
        () {
      final value1 = DoublePrecision(2.5);
      final value2 = DoublePrecision(DoublePrecision.maxValue);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying DoublePrecision underflows',
        () {
      final value1 = DoublePrecision(2.5);
      final value2 = DoublePrecision(DoublePrecision.minValue);
      expect(() => value1 * value2, throwsRangeError);
    });
  });
}
