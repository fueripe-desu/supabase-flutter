...
//
  group('positive subtraction', () {
    test('should correctly subtract BigInteger', () {
      final value1 = DoublePrecision(30.3);
      final value2 = BigInteger(20);
      final expected = DoublePrecision(10.3);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly subtract fractional double', () {
      final value1 = DoublePrecision(30.3);
      const value2 = 20.5;
      final expected = DoublePrecision(9.8);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly subtract int Numeric', () {
      ...
      final expected = Numeric(value: '10.3', precision: 3, scale: 1);
    ...
    test('should correctly subtract float Numeric', () {
      ...
      final expected = Numeric(value: '9.8', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract fractional Numeric', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '49.95', precision: 4, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract Numeric with negative scale', () {
      final value1 = DoublePrecision(1950.3);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '950.3', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract fractional Decimal', () {
      ...
      final expected = Decimal(value: '49.95', precision: 4, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract Decimal with negative scale', () {
      ...
      final expected = Decimal(value: '950.3', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// is 1, and they cannot store negative values.
  group('negative subtraction', () {
    test('should correctly subtract BigInteger', () {
      ...
      final expected = DoublePrecision(-20.3);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly subtract fractional double', () {
      final value1 = DoublePrecision(-50.3);
      const value2 = -30.5;
      final expected = DoublePrecision(-19.8);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly subtract int Numeric', () {
      ...
      final expected = Numeric(value: '-20.3', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract float Numeric', () {
      ...
      final expected = Numeric(value: '-19.8', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract int Decimal', () {
      ...
      final expected = Decimal(value: '-20.3', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract float Decimal', () {
      ...
      final expected = Decimal(value: '-19.8', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// is 1, and they cannot store negative values.
  group('mixed sign subtraction (positive + negative)', () {
    test('should correctly subtract BigInteger', () {
      final value1 = DoublePrecision(50.3);
      final value2 = BigInteger(-30);
      final expected = DoublePrecision(80.3);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly subtract fractional double', () {
      final value1 = DoublePrecision(50.3);
      const value2 = -30.5;
      final expected = DoublePrecision(80.8);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly subtract int Numeric', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Numeric(value: '-30', precision: 2, scale: 0);
      final expected = Numeric(value: '80.3', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract float Numeric', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Numeric(value: '-30.5', precision: 3, scale: 1);
      final expected = Numeric(value: '80.8', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract fractional Numeric', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Numeric(value: '-0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '50.65', precision: 4, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract Numeric with negative scale', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
      final expected = Numeric(value: '1050.3', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract int Decimal', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Decimal(value: '-30', precision: 2, scale: 0);
      final expected = Decimal(value: '80.3', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract float Decimal', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Decimal(value: '-30.5', precision: 3, scale: 1);
      final expected = Decimal(value: '80.8', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract fractional Decimal', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Decimal(value: '-0.35', precision: 2, scale: 2);
      final expected = Decimal(value: '50.65', precision: 4, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract Decimal with negative scale', () {
      final value1 = DoublePrecision(50.3);
      final value2 = Decimal(value: '-1231', precision: 4, scale: -3);
      final expected = Decimal(value: '1050.3', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
//
  group('mixed sign subtraction (negative + positive)', () {
    test('should correctly subtract BigInteger', () {
      final value1 = DoublePrecision(-20.3);
      final value2 = BigInteger(30);
      final expected = DoublePrecision(-50.3);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly subtract fractional double', () {
      final value1 = DoublePrecision(-20.3);
      const value2 = 30.5;
      final expected = DoublePrecision(-50.8);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should correctly subtract int Numeric', () {
      final value1 = DoublePrecision(-20.3);
      final value2 = Numeric(value: '30', precision: 2, scale: 0);
      final expected = Numeric(value: '-50.3', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract float Numeric', () {
      final value1 = DoublePrecision(-20.3);
      final value2 = Numeric(value: '30.5', precision: 3, scale: 1);
      final expected = Numeric(value: '-50.8', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract int Decimal', () {
      final value1 = DoublePrecision(-20.3);
      final value2 = Decimal(value: '30', precision: 2, scale: 0);
      final expected = Decimal(value: '-50.3', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract float Decimal', () {
      final value1 = DoublePrecision(-20.3);
      final value2 = Decimal(value: '30.5', precision: 3, scale: 1);
      final expected = Decimal(value: '-50.8', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// separately in another test group within this file.
  group('positive result tests (positive + positive)', () {
    test('should return positive value when subtracting BigInteger', () {
      final value1 = DoublePrecision(40.3);
      final value2 = BigInteger(30);
      final expected = DoublePrecision(10.3);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    ...
    test(
      ...
      final value1 = DoublePrecision(40.3);
      final value2 = DoublePrecision(30.5);
      final expected = DoublePrecision(9.7);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should return positive value when subtracting fractional Numeric',
      ...
      final expected = Numeric(value: '40.16', precision: 4, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
        ...
        () {
      final value1 = DoublePrecision(2000.3);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '1000.3', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return positive value when subtracting fractional Decimal',
      ...
      final expected = Decimal(value: '40.16', precision: 4, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// test group within this file.
  group('negative result tests (positive + positive)', () {
    ...
    test('should return negative value when subtracting fractional double', () {
      final value1 = DoublePrecision(30.3);
      const value2 = 40.5;
      final expected = DoublePrecision(-10.2);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should return negative value when subtracting int Numeric', () {
      ...
      final expected = Numeric(value: '-9.7', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return negative value when subtracting float Numeric', () {
      ...
      final expected = Numeric(value: '-10.2', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return negative value when subtracting fractional Numeric',
        () {
      final value1 = DoublePrecision(0.2);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '-0.15', precision: 3, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
        ...
        () {
      final value1 = DoublePrecision(100.3);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '-899.7', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return negative value when subtracting int Decimal', () {
      ...
      final expected = Decimal(value: '-9.7', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return negative value when subtracting float Decimal', () {
      ...
      final expected = Decimal(value: '-10.2', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return negative value when subtracting fractional Decimal',
      ...
      final value1 = DoublePrecision(0.2);
      final value2 = Decimal(value: '0.35', precision: 2, scale: 2);
      final expected = Decimal(value: '-0.15', precision: 3, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value1 = DoublePrecision(100.3);
      final value2 = Decimal(value: '1231', precision: 4, scale: -3);
      final expected = Decimal(value: '-899.7', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// [fractional arbitrary precision].
  group('zero result tests (positive + positive)', () {
    ...
    test(
        ...
        () {
      final value1 = DoublePrecision(40.3);
      final value2 = DoublePrecision(40.3);
      final expected = DoublePrecision(0);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should return zero value when subtracting float Numeric', () {
      final value1 = DoublePrecision(40.3);
      final value2 = Numeric(value: '40.3', precision: 3, scale: 1);
    ...
    test(
        ...
        () {
      final value1 = DoublePrecision(40.3);
      final value2 = Numeric(value: '40.3');
      final expected = Numeric(value: '0.0', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });

    test('should return zero value when subtracting fractional Numeric', () {
      final value1 = DoublePrecision(0.35);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '0.0', precision: 3, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return zero value when subtracting float Decimal', () {
      final value1 = DoublePrecision(40.3);
      final value2 = Decimal(value: '40.3', precision: 3, scale: 1);
    ...
    test(
        ...
        () {
      final value1 = DoublePrecision(40.3);
      final value2 = Decimal(value: '40.3');
      final expected = Decimal(value: '0.0', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });

    test('should return zero value when subtracting fractional Decimal', () {
      final value1 = DoublePrecision(0.35);
      final value2 = Decimal(value: '0.35', precision: 2, scale: 2);
      final expected = Decimal(value: '0.0', precision: 3, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// is 1, and they cannot store negative values.
  group('positive result tests (negative + negative)', () {
    ...
    test('should return positive value when subtracting fractional double', () {
      final value1 = DoublePrecision(-30.3);
      const value2 = -40.5;
      final expected = DoublePrecision(10.1);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
...
// is 1, and they cannot store negative values.
  group('negative result tests (negative + negative)', () {
    ...
    test(
        'should return negative value when subtracting Numeric with negative scale',
        () {
      final value1 = DoublePrecision(-1900.3);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
      final expected = Numeric(value: '-900.3', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value1 = DoublePrecision(-1900.3);
      final value2 = Decimal(value: '-1231', precision: 4, scale: -3);
      final expected = Decimal(value: '-900.3', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// is 1, and they cannot store zero values.
  group('positive result tests (positive + negative)', () {
    test('should return positive value when subtracting BigInteger', () {
      final value1 = DoublePrecision(40.3);
      final value2 = BigInteger(-30);
      final expected = DoublePrecision(70.3);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should return positive value when subtracting fractional double', () {
      final value1 = DoublePrecision(40.3);
      const value2 = -30.5;
      final expected = DoublePrecision(70.8);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
    ...
    test('should return positive value when subtracting int Numeric', () {
      final value1 = DoublePrecision(40.3);
      final value2 = Numeric(value: '-30', precision: 2, scale: 0);
      final expected = Numeric(value: '70.3', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return positive value when subtracting float Numeric', () {
      final value1 = DoublePrecision(40.3);
      final value2 = Numeric(value: '-30.5', precision: 3, scale: 1);
      final expected = Numeric(value: '70.8', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value1 = DoublePrecision(2000.3);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
      final expected = Numeric(value: '3000.3', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return positive value when subtracting int Decimal', () {
      final value1 = DoublePrecision(40.3);
      final value2 = Decimal(value: '-30', precision: 2, scale: 0);
      final expected = Decimal(value: '70.3', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return positive value when subtracting float Decimal', () {
      final value1 = DoublePrecision(40.3);
      final value2 = Decimal(value: '-30.5', precision: 3, scale: 1);
      final expected = Decimal(value: '70.8', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value1 = DoublePrecision(2000.3);
      final value2 = Decimal(value: '-1231', precision: 4, scale: -3);
      final expected = Decimal(value: '3000.3', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// separately in another test group within this file.
  group('negative result tests (negative + positive)', () {
    ...
    test('should return negative value when subtracting fractional Numeric',
      ...
      final value1 = DoublePrecision(-40.3);
      final value2 = Numeric(value: '0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '-40.65', precision: 4, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return negative value when subtracting fractional Decimal',
      ...
      final value1 = DoublePrecision(-40.3);
      final value2 = Decimal(value: '0.35', precision: 2, scale: 2);
      final expected = Decimal(value: '-40.65', precision: 4, scale: 2);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// the minimum value constraint of [Serial types], which is 1.
  group('type casting', () {
    test('should return DoublePrecision as result when subtracting BigInteger',
        () {
      final value1 = DoublePrecision(1.3);
    ...
    test(
        'should return DoublePrecision as result when subtracting negative BigInteger',
        () {
      final value1 = DoublePrecision(1.3);
      final value2 = BigInteger(-1);
      final operation = (value1 - value2) as FloatingPointDataType;
    ...
    test('should return DoublePrecision as result when subtracting Integer',
        () {
      final value1 = DoublePrecision(1.3);
    ...
    test(
        'should return DoublePrecision as result when subtracting negative Integer',
        () {
      final value1 = DoublePrecision(1.3);
      final value2 = Integer(-1);
      final operation = (value1 - value2) as FloatingPointDataType;
    ...
    test(
        'should return DoublePrecision as result when subtracting SmallInteger',
        () {
      final value1 = DoublePrecision(1.3);
    ...
    test(
        'should return DoublePrecision as result when subtracting negative SmallInteger',
        () {
      final value1 = DoublePrecision(1.3);
      final value2 = SmallInteger(-1);
      final operation = (value1 - value2) as FloatingPointDataType;
    ...
    test('should return DoublePrecision as result when subtracting BigSerial',
        () {
      final value1 = DoublePrecision(1.3);
    ...
    test('should return DoublePrecision as result when subtracting Serial', () {
      final value1 = DoublePrecision(1.3);
    ...
    test('should return DoublePrecision as result when subtracting SmallSerial',
        () {
      final value1 = DoublePrecision(1.3);
    ...
    test(
        'should return DoublePrecision as result when subtracting int primitive',
        () {
      final value1 = DoublePrecision(1.3);
      const value2 = 1;
      final operation = (value1 - value2) as FloatingPointDataType;
    ...
    test(
        'should return DoublePrecision as result when subtracting negative int primitive',
        () {
      final value1 = DoublePrecision(1.3);
      const value2 = -1;
      final operation = (value1 - value2) as FloatingPointDataType;
    ...
    test(
        'should return DoublePrecision as result when subtracting double primitive',
        () {
      final value1 = DoublePrecision(1.3);
      const value2 = 1.5;
      final operation = (value1 - value2) as FloatingPointDataType;
    ...
    test(
        'should return DoublePrecision as result when subtracting negative double primitive',
        () {
      final value1 = DoublePrecision(1.3);
      const value2 = -1.5;
      final operation = (value1 - value2) as FloatingPointDataType;
    ...
    test('should return DoublePrecision as result when subtracting Real', () {
      final value1 = DoublePrecision(1.3);
      final value2 = Real(1);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation, isA<DoublePrecision>());
    ...
    test(
        'should return DoublePrecision as result when subtracting negative Real',
        () {
      final value1 = DoublePrecision(1.3);
      final value2 = Real(-1);
      final operation = (value1 - value2) as FloatingPointDataType;
