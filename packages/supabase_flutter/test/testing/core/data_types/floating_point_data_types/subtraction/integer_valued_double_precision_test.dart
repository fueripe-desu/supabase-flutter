...
//
  group('positive subtraction', () {
    ...
    test('should correctly subtract int Numeric', () {
      ...
      final expected = Numeric(value: '10', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract Numeric with negative scale', () {
      final value1 = DoublePrecision(1950);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '950', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract int Decimal', () {
      ...
      final expected = Decimal(value: '10', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract Decimal with negative scale', () {
      ...
      final expected = Decimal(value: '950', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// is 1, and they cannot store negative values.
  group('negative subtraction', () {
    ...
    test('should correctly subtract int Numeric', () {
      ...
      final expected = Numeric(value: '-20', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract int Decimal', () {
      ...
      final expected = Decimal(value: '-20', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// is 1, and they cannot store negative values.
  group('mixed sign subtraction (positive + negative)', () {
    ...
    test('should correctly subtract int Numeric', () {
      final value1 = DoublePrecision(50);
      final value2 = Numeric(value: '-30', precision: 2, scale: 0);
      final expected = Numeric(value: '80', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract Numeric with negative scale', () {
      final value1 = DoublePrecision(50);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
      final expected = Numeric(value: '1050', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract int Decimal', () {
      final value1 = DoublePrecision(50);
      final value2 = Decimal(value: '-30', precision: 2, scale: 0);
      final expected = Decimal(value: '80', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract Decimal with negative scale', () {
      final value1 = DoublePrecision(50);
      final value2 = Decimal(value: '-1231', precision: 4, scale: -3);
      final expected = Decimal(value: '1050', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
//
  group('mixed sign subtraction (negative + positive)', () {
    ...
    test('should correctly subtract int Numeric', () {
      final value1 = DoublePrecision(-20);
      final value2 = Numeric(value: '30', precision: 2, scale: 0);
      final expected = Numeric(value: '-50', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly subtract int Decimal', () {
      final value1 = DoublePrecision(-20);
      final value2 = Decimal(value: '30', precision: 2, scale: 0);
      final expected = Decimal(value: '-50', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
...
// separately in another test group within this file.
  group('positive result tests (positive + positive)', () {
    test('should return positive value when subtracting BigInteger', () {
      final value1 = DoublePrecision(40);
      final value2 = BigInteger(30);
      final expected = DoublePrecision(10);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    ...
    test(
        ...
        () {
      final value1 = DoublePrecision(2000);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '1000', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value1 = DoublePrecision(2000);
      final value2 = Decimal(value: '1231', precision: 4, scale: -3);
      final expected = Decimal(value: '1000', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// is not possible.
  group('negative result tests (positive + positive)', () {
    ...
    test(
        ...
        () {
      final value1 = DoublePrecision(100);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '-900', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value1 = DoublePrecision(100);
      final value2 = Decimal(value: '1231', precision: 4, scale: -3);
      final expected = Decimal(value: '-900', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// fractional part is exactly zero.
  group('zero result tests (positive + positive)', () {
    ...
    test(
        ...
        () {
      final value1 = DoublePrecision(1000);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '0', precision: 2, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
...
// is 1, and they cannot store negative values.
  group('negative result tests (negative + negative)', () {
    ...
    test(
        'should return negative value when subtracting Numeric with negative scale',
        () {
      final value1 = DoublePrecision(-1900);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
      final expected = Numeric(value: '-900', precision: 4, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
...
// is 1, and they cannot store zero values.
  group('positive result tests (positive + negative)', () {
    ...
    test('should return positive value when subtracting int Numeric', () {
      final value1 = DoublePrecision(40);
      final value2 = Numeric(value: '-30', precision: 2, scale: 0);
      final expected = Numeric(value: '70', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value1 = DoublePrecision(2000);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
      final expected = Numeric(value: '3000', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return positive value when subtracting int Decimal', () {
      final value1 = DoublePrecision(40);
      final value2 = Decimal(value: '-30', precision: 2, scale: 0);
      final expected = Decimal(value: '70', precision: 3, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value1 = DoublePrecision(2000);
      final value2 = Decimal(value: '-1231', precision: 4, scale: -3);
      final expected = Decimal(value: '3000', precision: 5, scale: 1);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
    });
  });
