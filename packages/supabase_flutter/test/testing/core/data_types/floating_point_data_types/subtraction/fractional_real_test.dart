...
//
  group('positive subtraction', () {
    test('should correctly subtract BigInteger', () {
      final value1 = Real(30.3);
      final value2 = BigInteger(20);
      final expected = Real(10.3);
...
//
  group('mixed sign subtraction (negative + positive)', () {
    test('should correctly subtract BigInteger', () {
      final value1 = Real(-20.3);
      final value2 = BigInteger(30);
      final expected = Real(-50.3);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation.closeTo(expected, 0.1), true);
    });
...
// the minimum value constraint of [Serial types], which is 1.
  group('type casting', () {
    test('should return Real as result when subtracting BigInteger', () {
      final value1 = Real(1.3);
      final value2 = BigInteger(1);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation, isA<Real>());
    });

    test('should return Real as result when subtracting negative BigInteger',
        () {
      final value1 = Real(1.3);
      final value2 = BigInteger(-1);
      final operation = (value1 - value2) as FloatingPointDataType;
    ...
    test('should return Real as result when subtracting Integer', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when subtracting negative Integer', () {
      final value1 = Real(1.3);
      final value2 = Integer(-1);
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when subtracting SmallInteger', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when subtracting negative SmallInteger',
        () {
      final value1 = Real(1.3);
      final value2 = SmallInteger(-1);
      final operation = (value1 - value2) as FloatingPointDataType;
    ...
    test('should return Real as result when subtracting BigSerial', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when subtracting Serial', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when subtracting SmallSerial', () {
      final value1 = Real(1.3);
    ...
    test('should return Real as result when subtracting int primitive', () {
      final value1 = Real(1.3);
      const value2 = 1;
      final operation = (value1 - value2) as FloatingPointDataType;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when subtracting negative int primitive',
        () {
      final value1 = Real(1.3);
      const value2 = -1;
      final operation = (value1 - value2) as FloatingPointDataType;
