...
// the minimum value requirement of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return BigInteger as result when multiplying Integer', () {
      final value1 = BigInteger(1);
    ...
    test('should return BigInteger as result when multiplying negative Integer',
        () {
      final value1 = BigInteger(1);
      final value2 = Integer(-1);
      final operation = value1 * value2;
    ...
    test('should return BigInteger as result when multiplying SmallInteger',
        () {
      final value1 = BigInteger(1);
    ...
    test(
        'should return BigInteger as result when multiplying negative SmallInteger',
        () {
      final value1 = BigInteger(1);
      final value2 = SmallInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return BigInteger as result when multiplying BigSerial', () {
      final value1 = BigInteger(1);
    ...
    test('should return BigInteger as result when multiplying Serial', () {
      final value1 = BigInteger(1);
    ...
    test('should return BigInteger as result when multiplying SmallSerial', () {
      final value1 = BigInteger(1);
    ...
    test('should return BigInteger as result when multiplying int primitive',
        () {
      final value1 = BigInteger(1);
      const value2 = 1;
      final operation = value1 * value2;
    ...
    test(
        'should return BigInteger as result when multiplying negative int primitive',
        () {
      final value1 = BigInteger(1);
      const value2 = -1;
      final operation = value1 * value2;
