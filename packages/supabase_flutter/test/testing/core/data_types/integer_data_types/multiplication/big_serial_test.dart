...
// the minimum value requirement of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return BigSerial as result when multiplying Serial', () {
      final value1 = BigSerial(1);
    ...
    test('should return BigSerial as result when multiplying SmallSerial', () {
      final value1 = BigSerial(1);
    ...
    test('should return BigSerial as result when multiplying int primitive',
        () {
      final value1 = BigSerial(1);
      const value2 = 1;
      final operation = value1 * value2;
...
// currently tested, focusing instead on promotions to higher precision.
  group('operation type promotion', () {
    test(
        ...
        () {
      final value1 = BigSerial(BigSerial.minValue);
      final value2 = BigInteger(2);
      final operation = value1 * value2;
      final expected = BigInteger(BigSerial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should promote correctly when multiplying Integer close to min value',
      ...
      final operation = value1 * value2;
      final expected = Integer(BigSerial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final operation = value1 * value2;
      final expected = SmallInteger(BigSerial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
  });
...
// test groups within this file.
  group('overflow and underflow errors', () {
    test('should throw RangeError if multiplying BigInteger overflows', () {
      final value1 = BigSerial(BigSerial.maxValue);
      final value2 = BigInteger(2);
