...
// the minimum value requirement of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return Serial as result when multiplying SmallSerial', () {
      final value1 = Serial(1);
    ...
    test('should return Serial as result when multiplying int primitive', () {
      final value1 = Serial(1);
      const value2 = 1;
      final operation = value1 * value2;
      expect(operation, isA<Serial>());
...
// currently tested, focusing instead on promotions to higher precision.
  group('operation type promotion', () {
    test(
        ...
        () {
      final value1 = Serial(Serial.minValue);
      final value2 = BigInteger(2);
      final operation = value1 * value2;
      final expected = BigInteger(Serial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
        ...
        () {
      final value1 = Serial(Serial.maxValue);
      final value2 = BigInteger(2);
      final operation = value1 * value2;
      final expected = BigInteger(Serial.maxValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should promote correctly when multiplying Integer close to min value',
      ...
      final operation = value1 * value2;
      final expected = Integer(Serial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final operation = value1 * value2;
      final expected = SmallInteger(Serial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final operation = value1 * value2;
      final expected = BigSerial(Serial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value2 = BigSerial(2);
      final operation = value1 * value2;
      final expected = BigSerial(Serial.maxValue * 2);
      expect(operation.identicalTo(expected), true);
    });
  });
