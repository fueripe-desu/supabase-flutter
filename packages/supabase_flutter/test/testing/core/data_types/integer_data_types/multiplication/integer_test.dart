...
// the minimum value requirement of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return Integer as result when multiplying SmallInteger', () {
      final value1 = Integer(1);
    ...
    test(
        'should return Integer as result when multiplying negative SmallInteger',
        () {
      final value1 = Integer(1);
      final value2 = SmallInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return Integer as result when multiplying BigSerial', () {
      final value1 = Integer(1);
    ...
    test('should return Integer as result when multiplying Serial', () {
      final value1 = Integer(1);
    ...
    test('should return Integer as result when multiplying SmallSerial', () {
      final value1 = Integer(1);
    ...
    test('should return Integer as result when multiplying int primitive', () {
      final value1 = Integer(1);
      const value2 = 1;
      final operation = value1 * value2;
      expect(operation, isA<Integer>());
    ...
    test(
        'should return Integer as result when multiplying negative int primitive',
        () {
      final value1 = Integer(1);
      const value2 = -1;
      final operation = value1 * value2;
...
// currently tested, focusing instead on promotions to higher precision.
  group('operation type promotion', () {
    test(
        ...
        () {
      final value1 = Integer(Integer.minValue);
      final value2 = BigInteger(2);
      final operation = value1 * value2;
      final expected = BigInteger(Integer.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
        ...
        () {
      final value1 = Integer(Integer.maxValue);
      final value2 = BigInteger(2);
      final operation = value1 * value2;
      final expected = BigInteger(Integer.maxValue * 2);
      expect(operation.identicalTo(expected), true);
    });
  });
