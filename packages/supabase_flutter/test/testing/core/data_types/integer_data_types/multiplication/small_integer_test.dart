...
// the minimum value requirement of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return SmallInteger as result when multiplying BigSerial', () {
      final value1 = SmallInteger(1);
    ...
    test('should return SmallInteger as result when multiplying Serial', () {
      final value1 = SmallInteger(1);
    ...
    test('should return SmallInteger as result when multiplying SmallSerial',
        () {
      final value1 = SmallInteger(1);
    ...
    test('should return SmallInteger as result when multiplying int primitive',
        () {
      final value1 = SmallInteger(1);
      const value2 = 1;
      final operation = value1 * value2;
    ...
    test(
        'should return SmallInteger as result when multiplying negative int primitive',
        () {
      final value1 = SmallInteger(1);
      const value2 = -1;
      final operation = value1 * value2;
...
// currently tested, focusing instead on promotions to higher precision.
  group('operation type promotion', () {
    test(
      ...
      final operation = value1 * value2;
      final expected = BigInteger(SmallInteger.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value2 = BigInteger(2);
      final operation = value1 * value2;
      final expected = BigInteger(SmallInteger.maxValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should promote correctly when multiplying Integer close to min value',
      ...
      final operation = value1 * value2;
      final expected = Integer(SmallInteger.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should promote correctly when multiplying Integer close to max value',
      ...
      final value2 = Integer(2);
      final operation = value1 * value2;
      final expected = Integer(SmallInteger.maxValue * 2);
      expect(operation.identicalTo(expected), true);
    });
  });
