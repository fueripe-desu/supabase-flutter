...
// Numeric(value: '1349') -> Unconstrained integer Numeric with the value '1349'
  group('positive multiplication', () {
    test('should correctly multiply BigInteger', () {
      final value1 = SmallSerial(20);
      final value2 = BigInteger(30);
      final expected = BigInteger(600);
    ...
    test('should correctly multiply SmallInteger', () {
      ...
      final expected = SmallInteger(600);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply SmallSerial', () {
      ...
      final expected = SmallSerial(600);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply integer-valued DoublePrecision', () {
      ...
      final expected = DoublePrecision(600);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply fractional DoublePrecision', () {
      ...
      final expected = DoublePrecision(610);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply Numeric with negative scale', () {
      final value1 = SmallSerial(2);
      final value2 = Numeric(value: '1231', precision: 4, scale: -3);
      final expected = Numeric(value: '2000', precision: 4, scale: 0);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply int Decimal', () {
      ...
      final expected = Decimal(value: '600', precision: 3, scale: 0);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply float Decimal', () {
      ...
      final expected = Decimal(value: '610.0', precision: 4, scale: 1);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply fractional Decimal', () {
      ...
      final expected = Decimal(value: '7.0', precision: 3, scale: 2);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply Decimal with negative scale', () {
      ...
      final expected = Decimal(value: '2000', precision: 4, scale: 0);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
//   Numeric(value: '1349') -> Unconstrained integer Numeric with the value '1349'
  group('mixed sign multiplication (positive + negative)', () {
    ...
    test('should correctly multiply fractional Numeric', () {
      final value1 = SmallSerial(50);
      final value2 = Numeric(value: '-0.35', precision: 2, scale: 2);
      final expected = Numeric(value: '-17.50', precision: 4, scale: 2);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly multiply fractional Decimal', () {
      final value1 = SmallSerial(50);
      final value2 = Decimal(value: '-0.35', precision: 2, scale: 2);
      final expected = Decimal(value: '-17.50', precision: 4, scale: 2);
      final operation = value1 * value2;
      expect(operation.identicalTo(expected), true);
    });
...
// the minimum value requirement of [Serial types], which is 1.
  group('type casting', () {
    test('should return BigInteger as result when multiplying BigInteger', () {
      final value1 = SmallSerial(1);
    ...
    test(
        'should return BigInteger as result when multiplying negative BigInteger',
        () {
      final value1 = SmallSerial(1);
      final value2 = BigInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return Integer as result when multiplying Integer', () {
      final value1 = SmallSerial(1);
    ...
    test('should return Integer as result when multiplying negative Integer',
        () {
      final value1 = SmallSerial(1);
      final value2 = Integer(-1);
      final operation = value1 * value2;
    ...
    test('should return SmallInteger as result when multiplying SmallInteger',
        () {
      final value1 = SmallSerial(1);
    ...
    test(
        'should return SmallInteger as result when multiplying negative SmallInteger',
        () {
      final value1 = SmallSerial(1);
      final value2 = SmallInteger(-1);
      final operation = value1 * value2;
    ...
    test('should return BigSerial as result when multiplying BigSerial', () {
      final value1 = SmallSerial(1);
      final value2 = BigSerial(1);
      final operation = value1 * value2;
      expect(operation, isA<BigSerial>());
    });

    test('should return Serial as result when multiplying Serial', () {
      final value1 = SmallSerial(1);
      final value2 = Serial(1);
      final operation = value1 * value2;
      expect(operation, isA<Serial>());
    });

    test('should return SmallSerial as result when multiplying SmallSerial',
        () {
      final value1 = SmallSerial(1);
      final value2 = SmallSerial(1);
      final operation = value1 * value2;
      expect(operation, isA<SmallSerial>());
    });

    test('should return SmallSerial as result when multiplying int primitive',
        () {
      final value1 = SmallSerial(1);
      const value2 = 1;
      final operation = value1 * value2;
    ...
    test('should return Real as result when multiplying double primitive', () {
      final value1 = SmallSerial(1);
      const value2 = 1.5;
      final operation = value1 * value2;
    ...
    test(
        'should return Real as result when multiplying negative double primitive',
        () {
      final value1 = SmallSerial(1);
      const value2 = -1.5;
      final operation = value1 * value2;
    ...
    test('should return Real as result when multiplying Real', () {
      final value1 = SmallSerial(1);
      final value2 = Real(1);
      final operation = value1 * value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when multiplying negative Real', () {
      final value1 = SmallSerial(1);
      final value2 = Real(-1);
      final operation = value1 * value2;
      expect(operation, isA<Real>());
    ...
    test(
        'should return DoublePrecision as result when multiplying DoublePrecision',
        () {
      final value1 = SmallSerial(1);
    ...
    test(
        'should return DoublePrecision as result when multiplying negative DoublePrecision',
        () {
      final value1 = SmallSerial(1);
      final value2 = DoublePrecision(-1);
      final operation = value1 * value2;
    ...
    test('should return Decimal as result when multiplying Decimal', () {
      final value1 = SmallSerial(1);
    ...
    test('should return Decimal as result when multiplying negative Decimal',
        () {
      final value1 = SmallSerial(1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 * value2;
...
// Tests if multiplication correctly promotes a less precise value
// to a more precise value when necessary.
//
// This group of tests verifies type promotion when the second operand is
// more precise than the first. Initiated by a subtle error found during
// development, these tests check if the range adjustments correctly
// accommodate the results of operations. Example:
//
// SmallInteger(SmallInteger.maxValue) * BigInteger(2)
//
// In this example, {SmallInteger} should be promoted to {BigInteger} to
// handle the multiplication result. Previously, a {RangeError} was thrown
// because the system checked against the range of the less precise operand.
// This test group aims to ensure that the issue has been resolved.
//
// Observations:
// - Tests exclude types with equal or lesser precision than those
// currently tested, focusing instead on promotions to higher precision.
  group('operation type promotion', () {
    test(
        'should promote correctly when multiplying BigInteger close to min value',
        () {
      final value1 = SmallSerial(SmallSerial.minValue);
      final value2 = BigInteger(2);
      final operation = value1 * value2;
      final expected = BigInteger(SmallSerial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });

    test(
        'should promote correctly when multiplying BigInteger close to max value',
        () {
      final value1 = SmallSerial(SmallSerial.maxValue);
      final value2 = BigInteger(2);
      final operation = value1 * value2;
      final expected = BigInteger(SmallSerial.maxValue * 2);
      expect(operation.identicalTo(expected), true);
    });

    test('should promote correctly when multiplying Integer close to min value',
        () {
      final value1 = SmallSerial(SmallSerial.minValue);
      final value2 = Integer(2);
      final operation = value1 * value2;
      final expected = Integer(SmallSerial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });

    test('should promote correctly when multiplying Integer close to max value',
        () {
      final value1 = SmallSerial(SmallSerial.maxValue);
      final value2 = Integer(2);
      final operation = value1 * value2;
      final expected = Integer(SmallSerial.maxValue * 2);
      expect(operation.identicalTo(expected), true);
    });

    test(
        'should promote correctly when multiplying SmallInteger close to min value',
        () {
      final value1 = SmallSerial(SmallSerial.minValue);
      final value2 = SmallInteger(2);
      final operation = value1 * value2;
      final expected = SmallInteger(SmallSerial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });

    test(
        'should promote correctly when multiplying BigSerial close to min value',
        () {
      final value1 = SmallSerial(SmallSerial.minValue);
      final value2 = BigSerial(2);
      final operation = value1 * value2;
      final expected = BigSerial(SmallSerial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });

    test(
        'should promote correctly when multiplying BigSerial close to max value',
        () {
      final value1 = SmallSerial(SmallSerial.maxValue);
      final value2 = BigSerial(2);
      final operation = value1 * value2;
      final expected = BigSerial(SmallSerial.maxValue * 2);
      expect(operation.identicalTo(expected), true);
    });

    test('should promote correctly when multiplying Serial close to min value',
        () {
      final value1 = SmallSerial(SmallSerial.minValue);
      final value2 = Serial(2);
      final operation = value1 * value2;
      final expected = Serial(SmallSerial.minValue * 2);
      expect(operation.identicalTo(expected), true);
    });

    test('should promote correctly when multiplying Serial close to max value',
        () {
      final value1 = SmallSerial(SmallSerial.maxValue);
      final value2 = Serial(2);
      final operation = value1 * value2;
      final expected = Serial(SmallSerial.maxValue * 2);
      expect(operation.identicalTo(expected), true);
    });
  });

// Tests if multiplication throws a RangeError when the result value
// overflows or underflows.
//
// This group of tests checks for correct error handling concerning overflow
// and underflow in multiplication across all supported data types. The
// operations adhere to PostgreSQL's numeric types range specifications,
// detailed in their documentation:
// https://www.postgresql.org/docs/current/datatype-numeric.html
//
// Based on this documentation, multiplication can cause overflow or underflow
// in two main scenarios:
//
// 1. Multiplying two values of the same type where the result exceeds the range
//    of that type, as there is no larger type available for casting. Examples
//    include:
//    - BigInteger(BigInteger.maxValue) * BigInteger(2)
//    - BigInteger(BigInteger.minValue) * BigInteger(-2)
//
// 2. Overflowing or underflowing the largest operand during multiplication,
//    without a larger type available for accommodating the result. Examples
//    include:
//    - Integer(Integer.maxValue) * SmallInteger(2) -> SmallInteger is cast to
//                                                     Integer.
//    - Integer(Integer.minValue) * SmallInteger(-2)
//    - SmallInteger(2) * Integer(Integer.maxValue)
//    - SmallInteger(-2) * Integer(Integer.minValue)
//
// However, overflow or underflow will not occur in the following situations:
//
// 1. When the smallest type in the operation can be cast to a larger type, which
//    can accommodate the result without overflow:
//
//    - SmallInteger(SmallInteger.maxValue) * Integer(2)
//
//    This operation may appear to cause overflow, but SmallInteger is cast to
//    Integer, which has sufficient precision to handle the result without issue.
//
// 2. When one of the operands is a floating point or Numeric type with a large
//    enough range to accommodate the result:
//
//    - BigInteger(BigInteger.maxValue) * Real(1.5)
//
//    Here, BigInteger is cast to Real, which has a sufficiently large range to
//    prevent overflow.
//
// The primary focus of these tests is on identifying the type of error
// (e.g., RangeError) thrown, rather than the value or type correctness.
// Multiplication in various scenarios and type casting issues are examined in other
// test groups within this file.
  group('overflow and underflow errors', () {
    test('should throw RangeError if multiplying BigInteger overflows', () {
      final value1 = SmallSerial(2);
      final value2 = BigInteger(BigInteger.maxValue);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying BigInteger underflows', () {
      final value1 = SmallSerial(2);
      final value2 = BigInteger(BigInteger.minValue);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying Integer overflows', () {
      final value1 = SmallSerial(2);
      final value2 = Integer(Integer.maxValue);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying Integer underflows', () {
      final value1 = SmallSerial(2);
      final value2 = Integer(Integer.minValue);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying SmallInteger overflows', () {
      final value1 = SmallSerial(SmallSerial.maxValue);
      final value2 = SmallInteger(2);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying SmallInteger underflows', () {
      final value1 = SmallSerial(2);
      final value2 = SmallInteger(SmallInteger.minValue);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying BigSerial overflows', () {
      final value1 = SmallSerial(2);
      final value2 = BigSerial(BigSerial.maxValue);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying Serial overflows', () {
      final value1 = SmallSerial(2);
      final value2 = Serial(Serial.maxValue);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying SmallSerial overflows', () {
      final value1 = SmallSerial(SmallSerial.maxValue);
      final value2 = SmallSerial(2);
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying int primitive overflows', () {
      final value1 = SmallSerial(SmallSerial.maxValue);
      const value2 = 2;
      expect(() => value1 * value2, throwsRangeError);
    });

    test('should throw RangeError if multiplying int primitive underflows', () {
      final value1 = SmallSerial(SmallSerial.minValue);
      const value2 = -2;
      expect(() => value1 * value2, throwsRangeError);
    });
