...
// which is 1.
  group('type casting', () {
    ...
    test('should return Serial as result when adding SmallSerial', () {
      final value1 = Serial(1);
    ...
    test('should return Serial as result when adding int primitive', () {
      final value1 = Serial(1);
      const value2 = 1;
      final operation = value1 + value2;
      expect(operation, isA<Serial>());
    ...
    test('should return Serial as result when adding negative int primitive',
        () {
...
// already tested in this file.
  group('operation type promotion', () {
    ...
    test('should promote correctly when adding BigSerial close to max value',
      ...
      final operation = value1 + value2;
      final expected = BigSerial(Serial.maxValue + 20);
      expect(operation.identicalTo(expected), true);
    });
  });
