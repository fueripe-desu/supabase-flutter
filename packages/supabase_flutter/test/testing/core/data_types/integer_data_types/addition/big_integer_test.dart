...
// which is 1.
  group('type casting', () {
    ...
    test('should return BigInteger as result when adding Integer', () {
      final value1 = BigInteger(1);
    ...
    test('should return BigInteger as result when adding negative Integer', () {
      final value1 = BigInteger(1);
      final value2 = Integer(-1);
      final operation = value1 + value2;
      expect(operation, isA<BigInteger>());
    ...
    test('should return BigInteger as result when adding SmallInteger', () {
      final value1 = BigInteger(1);
    ...
    test('should return BigInteger as result when adding negative SmallInteger',
        () {
      final value1 = BigInteger(1);
      final value2 = SmallInteger(-1);
      final operation = value1 + value2;
    ...
    test('should return BigInteger as result when adding BigSerial', () {
      final value1 = BigInteger(1);
    ...
    test('should return BigInteger as result when adding Serial', () {
      final value1 = BigInteger(1);
    ...
    test('should return BigInteger as result when adding SmallSerial', () {
      final value1 = BigInteger(1);
    ...
    test('should return BigInteger as result when adding int primitive', () {
      final value1 = BigInteger(1);
      const value2 = 1;
      final operation = value1 + value2;
      expect(operation, isA<BigInteger>());
    ...
    test(
        'should return BigInteger as result when adding negative int primitive',
        () {
      final value1 = BigInteger(1);
      const value2 = -1;
      final operation = value1 + value2;
