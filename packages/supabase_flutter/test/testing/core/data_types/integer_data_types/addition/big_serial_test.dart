...
// which is 1.
  group('type casting', () {
    ...
    test('should return BigSerial as result when adding Serial', () {
      final value1 = BigSerial(1);
    ...
    test('should return BigSerial as result when adding SmallSerial', () {
      final value1 = BigSerial(1);
    ...
    test('should return BigSerial as result when adding int primitive', () {
      final value1 = BigSerial(1);
      const value2 = 1;
      final operation = value1 + value2;
      expect(operation, isA<BigSerial>());
    ...
    test('should return BigSerial as result when adding negative int primitive',
        () {
