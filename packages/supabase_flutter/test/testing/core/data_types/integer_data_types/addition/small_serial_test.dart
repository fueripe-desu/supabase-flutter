...
// which is 1.
  group('type casting', () {
    ...
    test('should return BigSerial as result when adding BigSerial', () {
      final value1 = SmallSerial(1);
    ...
    test('should return Serial as result when adding Serial', () {
      final value1 = SmallSerial(1);
    ...
    test('should return SmallSerial as result when adding SmallSerial', () {
      final value1 = SmallSerial(1);
    ...
    test('should return SmallSerial as result when adding int primitive', () {
      final value1 = SmallSerial(1);
      const value2 = 1;
      final operation = value1 + value2;
      expect(operation, isA<SmallSerial>());
    ...
    test(
        'should return SmallSerial as result when adding negative int primitive',
        () {
...
// already tested in this file.
  group('operation type promotion', () {
    ...
    test('should promote correctly when adding SmallInteger close to min value',
        () {
      final value1 = SmallSerial(SmallSerial.minValue);
    ...
    test('should promote correctly when adding BigSerial close to max value',
        () {
      final value1 = SmallSerial(SmallSerial.maxValue);
      final value2 = BigSerial(20);
      final operation = value1 + value2;
      final expected = BigSerial(SmallSerial.maxValue + 20);
      expect(operation.identicalTo(expected), true);
    });

    test('should promote correctly when adding Serial close to max value', () {
      final value1 = SmallSerial(SmallSerial.maxValue);
      final value2 = Serial(20);
      final operation = value1 + value2;
      final expected = Serial(SmallSerial.maxValue + 20);
      expect(operation.identicalTo(expected), true);
    });
  });
...
// and type casting are evaluated separately in other test groups within this file.
  group('overflow and underflow errors', () {
    ...
    test('should throw RangeError if adding SmallInteger overflows', () {
      final value1 = SmallSerial(20);
      final value2 = SmallInteger(SmallInteger.maxValue);
      expect(() => value1 + value2, throwsRangeError);
    });
