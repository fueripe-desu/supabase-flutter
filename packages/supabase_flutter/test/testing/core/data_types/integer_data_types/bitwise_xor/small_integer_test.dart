...
// Tests if the bitwise XOR operator functions correctly with values where bits
...
// Tests if the bitwise XOR operator functions correctly with values where no bits are set.
//
// This test group verifies the correctness of the bitwise XOR operator when applied
...
// XOR operation with zero, which should also result in zero. Additionally, the tests
...
// Tests if the bitwise XOR operator functions correctly with negative operands having
// mixed bit settings.
//
// This test group verifies the correctness of the bitwise XOR operator when applied
