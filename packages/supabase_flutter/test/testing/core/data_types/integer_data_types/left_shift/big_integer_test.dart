...
// the type's storage with zeros.
  group('maximum shift', () {
    test('should shift correctly by the maximum allowed value (positive)', () {
      final value1 = BigInteger(1);
      final value2 = BigInteger(63);
      final expected = BigInteger(BigInteger.minValue);
      final operation = value1 << value2;
      expect(operation.identicalTo(expected), true);
    });

    test('should shift correctly by the maximum allowed value (negative)', () {
      final value1 = BigInteger(-1);
      final value2 = BigInteger(63);
      final expected = BigInteger(BigInteger.minValue);
      final operation = value1 << value2;
