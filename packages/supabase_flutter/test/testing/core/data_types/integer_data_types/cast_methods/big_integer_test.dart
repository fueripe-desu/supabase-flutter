...
void main() {
  ...
  group('overflow and underflow errors', () {
    ...
    test('should throw RangeError if value underflows SmallInteger', () {
      final value = BigInteger(BigInteger.minValue);
      expect(() => value.toSmallInteger(), throwsRangeError);
    });

    test('should throw RangeError if value overflows Integer', () {
      final value = BigInteger(BigInteger.maxValue);
      expect(() => value.toInteger(), throwsRangeError);
    });

    test('should throw RangeError if value underflows Integer', () {
      final value = BigInteger(BigInteger.minValue);
      expect(() => value.toInteger(), throwsRangeError);
    });
    ...
    test('should throw RangeError if value overflows Serial', () {
      final value = BigInteger(BigInteger.maxValue);
