...
// comparison in such scenarios.
  ...
  group('general errors', () {
    test('should throw ArgumentError if compared to an unsupported value', () {
      expect(
        () => Serial(20).compareTo(DateTime(2022)),
        throwsArgumentError,
      );
    });
  });
