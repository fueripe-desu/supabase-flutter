...
void main() {
  ...
  group('type casting', () {
    ...
    test('should return Serial as result when dividing Serial', () {
      final value1 = Serial(1);
      final value2 = Serial(1);
      final operation = value1 ~/ value2;
    ...
    test('should return Serial as result when dividing SmallSerial', () {
      final value1 = Serial(1);
      final value2 = SmallSerial(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<Serial>());
    ...
    test('should return Serial as result when dividing int primitive', () {
      final value1 = Serial(1);
      const value2 = 1;
      final operation = value1 ~/ value2;
      expect(operation, isA<Serial>());
