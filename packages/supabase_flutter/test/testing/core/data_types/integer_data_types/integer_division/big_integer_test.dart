...
//   due to the minimum {value} of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return BigInteger as result when dividing Integer', () {
      final value1 = BigInteger(1);
      final value2 = Integer(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test('should return BigInteger as result when dividing negative Integer',
        () {
      final value1 = BigInteger(1);
      final value2 = Integer(-1);
      final operation = value1 ~/ value2;
    ...
    test('should return BigInteger as result when dividing SmallInteger', () {
      final value1 = BigInteger(1);
      final value2 = SmallInteger(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test(
        'should return BigInteger as result when dividing negative SmallInteger',
        () {
      final value1 = BigInteger(1);
      final value2 = SmallInteger(-1);
      final operation = value1 ~/ value2;
    ...
    test('should return BigInteger as result when dividing BigSerial', () {
      final value1 = BigInteger(1);
      final value2 = BigSerial(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test('should return BigInteger as result when dividing Serial', () {
      final value1 = BigInteger(1);
      final value2 = Serial(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test('should return BigInteger as result when dividing SmallSerial', () {
      final value1 = BigInteger(1);
      final value2 = SmallSerial(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test('should return BigInteger as result when dividing int primitive', () {
      final value1 = BigInteger(1);
      const value2 = 1;
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test(
        'should return BigInteger as result when dividing negative int primitive',
        () {
      final value1 = BigInteger(1);
      const value2 = -1;
      final operation = value1 ~/ value2;
    ...
    test('should return BigInteger as result when dividing double primitive',
        () {
      final value1 = BigInteger(1);
      const value2 = 1.5;
      final operation = value1 ~/ value2;
    ...
    test(
        'should return BigInteger as result when dividing negative double primitive',
        () {
      final value1 = BigInteger(1);
      const value2 = -1.5;
      final operation = value1 ~/ value2;
    ...
    test('should return BigInteger as result when dividing Real', () {
      final value1 = BigInteger(1);
      final value2 = Real(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test('should return BigInteger as result when dividing negative Real', () {
      final value1 = BigInteger(1);
      final value2 = Real(-1);
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test('should return BigInteger as result when dividing DoublePrecision',
        () {
      final value1 = BigInteger(1);
      final value2 = DoublePrecision(1);
      final operation = value1 ~/ value2;
    ...
    test(
        'should return BigInteger as result when dividing negative DoublePrecision',
        () {
      final value1 = BigInteger(1);
      final value2 = DoublePrecision(-1);
      final operation = value1 ~/ value2;
    ...
    test('should return BigInteger as result when dividing Numeric', () {
      final value1 = BigInteger(1);
      final value2 = Numeric(value: '1', precision: 1, scale: 0);
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test('should return BigInteger as result when dividing negative Numeric',
        () {
      final value1 = BigInteger(1);
      final value2 = Numeric(value: '-1', precision: 1, scale: 0);
      final operation = value1 ~/ value2;
    ...
    test('should return BigInteger as result when dividing Decimal', () {
      final value1 = BigInteger(1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 ~/ value2;
      expect(operation, isA<BigInteger>());
    ...
    test('should return BigInteger as result when dividing negative Decimal',
        () {
      final value1 = BigInteger(1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 ~/ value2;
...
// Tests if integer division throws a {RangeError} if the result is
// too large for an [Integer type] to store.
//
// For [Integer types], the only scenario leading to overflow is dividing
// the minimum value by -1. This operation switches the sign, potentially
// resulting in a value larger than the maximum allowable value.
  group('overflow errors', () {
    test('should throw RangeError when dividing BigInteger overflows', () {
      final value1 = BigInteger(BigInteger.minValue);
      final value2 = BigInteger(-1);
      expect(() => value1 ~/ value2, throwsRangeError);
    });

    test('should throw RangeError when dividing Integer overflows', () {
      final value1 = BigInteger(BigInteger.minValue);
      final value2 = Integer(-1);
      expect(() => value1 ~/ value2, throwsRangeError);
    });

    test('should throw RangeError when dividing SmallInteger overflows', () {
      final value1 = BigInteger(BigInteger.minValue);
      final value2 = SmallInteger(-1);
      expect(() => value1 ~/ value2, throwsRangeError);
    });

    test('should throw RangeError when dividing Real overflows', () {
      final value1 = BigInteger(BigInteger.minValue);
      final value2 = Real(-1);
      expect(() => value1 ~/ value2, throwsRangeError);
    });

    test('should throw RangeError when dividing DoublePrecision overflows', () {
      final value1 = BigInteger(BigInteger.minValue);
      final value2 = DoublePrecision(-1);
      expect(() => value1 ~/ value2, throwsRangeError);
    });

    test('should throw RangeError when dividing Numeric overflows', () {
      final value1 = BigInteger(BigInteger.minValue);
      final value2 = Numeric(value: '-1', precision: 1, scale: 0);
      expect(() => value1 ~/ value2, throwsRangeError);
    });

    test('should throw RangeError when dividing Decimal overflows', () {
      final value1 = BigInteger(BigInteger.minValue);
      final value2 = Decimal(value: '-1', precision: 1, scale: 0);
      expect(() => value1 ~/ value2, throwsRangeError);
    });
