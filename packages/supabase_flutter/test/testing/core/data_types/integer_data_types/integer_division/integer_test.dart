...
//   due to the minimum {value} of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return Integer as result when dividing SmallInteger', () {
      final value1 = Integer(1);
      final value2 = SmallInteger(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing negative SmallInteger',
        () {
      final value1 = Integer(1);
      final value2 = SmallInteger(-1);
      final operation = value1 ~/ value2;
    ...
    test('should return Integer as result when dividing BigSerial', () {
      final value1 = Integer(1);
      final value2 = BigSerial(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing Serial', () {
      final value1 = Integer(1);
      final value2 = Serial(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing SmallSerial', () {
      final value1 = Integer(1);
      final value2 = SmallSerial(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing int primitive', () {
      final value1 = Integer(1);
      const value2 = 1;
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing negative int primitive',
        () {
      final value1 = Integer(1);
      const value2 = -1;
      final operation = value1 ~/ value2;
    ...
    test('should return Integer as result when dividing double primitive', () {
      final value1 = Integer(1);
      const value2 = 1.5;
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test(
        'should return Integer as result when dividing negative double primitive',
        () {
      final value1 = Integer(1);
      const value2 = -1.5;
      final operation = value1 ~/ value2;
    ...
    test('should return Integer as result when dividing Real', () {
      final value1 = Integer(1);
      final value2 = Real(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing negative Real', () {
      final value1 = Integer(1);
      final value2 = Real(-1);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing DoublePrecision', () {
      final value1 = Integer(1);
      final value2 = DoublePrecision(1);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test(
        'should return Integer as result when dividing negative DoublePrecision',
        () {
      final value1 = Integer(1);
      final value2 = DoublePrecision(-1);
      final operation = value1 ~/ value2;
    ...
    test('should return Integer as result when dividing Numeric', () {
      final value1 = Integer(1);
      final value2 = Numeric(value: '1', precision: 1, scale: 0);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing negative Numeric', () {
      final value1 = Integer(1);
      final value2 = Numeric(value: '-1', precision: 1, scale: 0);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing Decimal', () {
      final value1 = Integer(1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
    ...
    test('should return Integer as result when dividing negative Decimal', () {
      final value1 = Integer(1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 ~/ value2;
      expect(operation, isA<Integer>());
