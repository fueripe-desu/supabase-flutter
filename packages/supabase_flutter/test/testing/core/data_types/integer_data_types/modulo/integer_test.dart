...
//   minimum {value} of [Serial types], which is 1.
  group('type casting', () {
    ...
    test(
        'should return Integer as result when performing modulo by SmallInteger',
        () {
      final value1 = Integer(1);
      final value2 = SmallInteger(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Integer as result when performing modulo by negative SmallInteger',
        () {
      final value1 = Integer(1);
      final value2 = SmallInteger(-1);
      final operation = value1 % value2;
    ...
    test('should return Integer as result when performing modulo by BigSerial',
        () {
      final value1 = Integer(1);
      final value2 = BigSerial(1);
      final operation = value1 % value2;
    ...
    test('should return Integer as result when performing modulo by Serial',
        () {
      final value1 = Integer(1);
      final value2 = Serial(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Integer as result when performing modulo by SmallSerial',
        () {
      final value1 = Integer(1);
      final value2 = SmallSerial(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Integer as result when performing modulo by int primitive',
        () {
      final value1 = Integer(1);
      const value2 = 1;
      final operation = value1 % value2;
    ...
    test(
        'should return Integer as result when performing modulo by negative int primitive',
        () {
      final value1 = Integer(1);
      const value2 = -1;
      final operation = value1 % value2;
