...
//   minimum {value} of [Serial types], which is 1.
  group('type casting', () {
    ...
    test(
        ...
        () {
      final value1 = BigSerial(10);
      final value2 = BigSerial(3);
      final operation = value1 % value2;
      expect(operation, isA<BigSerial>());
    });

    test('should return BigSerial as result when performing modulo by Serial',
        () {
      final value1 = BigSerial(10);
    ...
    test(
        'should return BigSerial as result when performing modulo by SmallSerial',
        () {
      final value1 = BigSerial(10);
    ...
    test(
        'should return BigSerial as result when performing modulo by int primitive',
        () {
      final value1 = BigSerial(10);
      const value2 = 3;
      final operation = value1 % value2;
    ...
    test(
        'should return BigSerial as result when performing modulo by negative int primitive',
        () {
      final value1 = BigSerial(10);
      const value2 = -3;
      final operation = value1 % value2;
