...
//   the divisor evenly divides the dividend.
  group('integer modulo (exact)', () {
    test('should correctly perform module with BigInteger', () {
    ...
    test('should correctly perform module with Integer', () {
      final value1 = SmallSerial(50);
    ...
    test('should correctly perform module with SmallInteger', () {
      final value1 = SmallSerial(50);
    ...
    test('should correctly perform module with int Numeric', () {
      final value1 = SmallSerial(50);
    ...
    test('should correctly perform module with unconstrained int Numeric', () {
      final value1 = SmallSerial(50);
    ...
    test('should correctly perform module with int Decimal', () {
      final value1 = SmallSerial(50);
    ...
    test('should correctly perform module with unconstrained int Decimal', () {
      final value1 = SmallSerial(50);
...
//   minimum {value} of [Serial types], which is 1.
  group('type casting', () {
    test(
        'should return BigInteger as result when performing modulo by BigInteger',
        () {
    ...
    test(
        'should return BigInteger as result when performing modulo by negative BigInteger',
        () {
      final value1 = SmallSerial(1);
      final value2 = BigInteger(-1);
      final operation = value1 % value2;
    ...
    test('should return Integer as result when performing modulo by Integer',
        () {
      final value1 = SmallSerial(1);
      final value2 = Integer(1);
      final operation = value1 % value2;
    ...
    test(
        'should return Integer as result when performing modulo by negative Integer',
        () {
      final value1 = SmallSerial(1);
      final value2 = Integer(-1);
      final operation = value1 % value2;
    ...
    test(
        'should return SmallInteger as result when performing modulo by SmallInteger',
        () {
      final value1 = SmallSerial(1);
      final value2 = SmallInteger(1);
      final operation = value1 % value2;
    ...
    test(
        'should return SmallInteger as result when performing modulo by negative SmallInteger',
        () {
      final value1 = SmallSerial(1);
      final value2 = SmallInteger(-1);
      final operation = value1 % value2;
    ...
    test(
        'should return BigSerial as result when performing modulo by BigSerial',
        () {
      final value1 = SmallSerial(10);
      final value2 = BigSerial(3);
      final operation = value1 % value2;
      expect(operation, isA<BigSerial>());
    });

    test('should return Serial as result when performing modulo by Serial', () {
      final value1 = SmallSerial(10);
      final value2 = Serial(3);
      final operation = value1 % value2;
      expect(operation, isA<Serial>());
    });

    test(
        'should return SmallSerial as result when performing modulo by SmallSerial',
        () {
      final value1 = SmallSerial(10);
      final value2 = SmallSerial(3);
      final operation = value1 % value2;
      expect(operation, isA<SmallSerial>());
    });

    test(
        'should return SmallSerial as result when performing modulo by int primitive',
        () {
      final value1 = SmallSerial(10);
      const value2 = 3;
      final operation = value1 % value2;
    ...
    test(
        'should return SmallSerial as result when performing modulo by negative int primitive',
        () {
      final value1 = SmallSerial(10);
      const value2 = -3;
      final operation = value1 % value2;
