...
//   Numeric(value: '1349') -> Unconstrained int Numeric with value '1349'
  group('positive modulo', () {
    ...
    test('should correctly perform modulo with Numeric with negative scale',
        () {
      final value1 = SmallInteger(3100);
...
//   the divisor evenly divides the dividend.
  group('integer modulo (exact)', () {
    ...
    test('should correctly perform module with BigSerial', () {
      final value1 = SmallInteger(50);
    ...
    test('should correctly perform module with Serial', () {
      final value1 = SmallInteger(50);
    ...
    test('should correctly perform module with SmallSerial', () {
      final value1 = SmallInteger(50);
    ...
    test('should correctly perform module with int primitive', () {
      final value1 = SmallInteger(50);
      const value2 = 2;
      final expected = SmallInteger(0);
      final operation = value1 % value2;
...
//   minimum {value} of [Serial types], which is 1.
  group('type casting', () {
    ...
    test(
        'should return SmallInteger as result when performing modulo by BigSerial',
        () {
      final value1 = SmallInteger(1);
      final value2 = BigSerial(1);
      final operation = value1 % value2;
    ...
    test(
        'should return SmallInteger as result when performing modulo by Serial',
        () {
      final value1 = SmallInteger(1);
      final value2 = Serial(1);
      final operation = value1 % value2;
    ...
    test(
        'should return SmallInteger as result when performing modulo by SmallSerial',
        () {
      final value1 = SmallInteger(1);
      final value2 = SmallSerial(1);
      final operation = value1 % value2;
    ...
    test(
        'should return SmallInteger as result when performing modulo by int primitive',
        () {
      final value1 = SmallInteger(1);
      const value2 = 1;
      final operation = value1 % value2;
    ...
    test(
        'should return SmallInteger as result when performing modulo by negative int primitive',
        () {
      final value1 = SmallInteger(1);
      const value2 = -1;
      final operation = value1 % value2;
