...
//   minimum {value} of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return Serial as result when performing modulo by SmallSerial',
        () {
      final value1 = Serial(10);
    ...
    test(
        'should return Serial as result when performing modulo by int primitive',
        () {
      final value1 = Serial(10);
      const value2 = 3;
      final operation = value1 % value2;
    ...
    test(
        'should return Serial as result when performing modulo by negative int primitive',
        () {
      final value1 = Serial(10);
      const value2 = -3;
      final operation = value1 % value2;
