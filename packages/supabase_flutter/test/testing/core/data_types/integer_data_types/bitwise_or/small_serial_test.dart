...
// these conditions.
  group('all bits set (positive)', () {
    test('should retain all bits from BigInteger', () {
      ...
      final value1 = SmallSerial(bitValue - 1);
    ...
    test('should retain all bits from Integer', () {
      const bitValue = (1 << 15) - 1;
      final value1 = SmallSerial(bitValue);
    ...
    test('should retain all bits from SmallInteger', () {
      ...
      final expected = SmallSerial(bitValue);
      final operation = value1 | value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// the maximum value are included.
  group('mixed bits set (positive)', () {
    test('should return itself when performing bitwise with zero BigInteger',
      ...
      const noBits = 0 << 15;
      final value1 = SmallSerial(allBits - 1);
    ...
    test('should return itself when performing bitwise with zero Integer', () {
      const allBits = (1 << 15) - 1;
      const noBits = 0 << 15;
      final value1 = SmallSerial(allBits);
...
// {value} is 1, and they cannot store negative values.
  group('alternating 1s and 0s', () {
    test('should return all 1s when performing bitwise with BigInteger', () {
      final value1 = SmallSerial(binary('10101010'));
...
// {value} is 1, and they cannot store negative values.
  group('random alternating patterns', () {
    test('should return all 1s when performing bitwise with BigInteger', () {
      final value1 = SmallSerial(binary('10110100'));
...
// types are maintained under these conditions.
  group('random overlapping patterns', () {
    test('should return 43 when performing bitwise with BigInteger', () {
      final value1 = SmallSerial(binary('00101011'));
    ...
    test('should return 43 when performing bitwise with BigSerial', () {
      ...
      final expected = BigSerial(binary('00101111'));
      final operation = value1 | value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return 43 when performing bitwise with Serial', () {
      ...
      final expected = Serial(binary('00101111'));
      final operation = value1 | value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return 43 when performing bitwise with SmallSerial', () {
      ...
      final expected = SmallSerial(binary('00101111'));
      final operation = value1 | value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// {value} is 1, and they cannot store negative values.
  group('non-overlapping single bit', () {
    test('should return 3 when performing bitwise with BigInteger', () {
      final value1 = SmallSerial(binary('00000001'));
...
// maintained under these conditions.
  group('single bit value', () {
    ...
    test('should return 1 when performing bitwise with SmallSerial', () {
      ...
      final expected = SmallSerial(binary('00000001'));
      final operation = value1 | value2;
      expect(operation.identicalTo(expected), true);
    });
  });
  ...
  group('general errors', () {
    test(
        ...
        () {
      expect(
        () => SmallSerial(binary('00000000')) | 'sample',
        throwsArgumentError,
      );
    });
  });
