...
// Numeric(value: '1349') -> Unconstrained int Numeric with value '1349'
  group('positive division', () {
    ...
    test('should correctly divide integer-valued DoublePrecision', () {
      ...
      final expected = DoublePrecision(15);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide fractional DoublePrecision', () {
      ...
      final expected = DoublePrecision(12);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide Numeric with negative scale', () {
      final value1 = SmallInteger(3000);
    ...
    test('should correctly divide int Decimal', () {
      ...
      final expected = Decimal(value: '15', precision: 22, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide float Decimal', () {
      ...
      final expected = Decimal(value: '12', precision: 22, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should correctly divide Decimal with negative scale', () {
      ...
      final expected = Decimal(value: '3', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
// [Integer types] only.
  group('integer division (exact)', () {
    ...
    test('should correctly divide int Decimal', () {
      final value1 = SmallInteger(50);
      final value2 = Decimal(value: '2', precision: 1, scale: 0);
      final expected = Decimal(value: '25', precision: 22, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   and [Integer types].
  group('integer division (fractional)', () {
    ...
    test('should correctly divide int Decimal', () {
      final value1 = SmallInteger(5);
      final value2 = Decimal(value: '2', precision: 1, scale: 0);
      final expected = Decimal(value: '2.5', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   and [floating point types].
  group('integer-valued floating point division (exact)', () {
    ...
    test('should correctly divide DoublePrecision', () {
      ...
      final expected = DoublePrecision(25);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   [floating point types].
  group('integer-valued floating point division (fractional)', () {
    ...
    test('should correctly divide DoublePrecision', () {
      final value1 = SmallInteger(5);
      final value2 = DoublePrecision(2);
      final expected = DoublePrecision(2.5);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   by a floating point number with decimals results in an exact integer outcome.
  group('fractional floating point division (exact)', () {
    ...
    test('should correctly divide float Decimal', () {
      ...
      final expected = Decimal(value: '4', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   by a floating point number results in a fractional outcome.
  group('fractional floating point division (fractional)', () {
    test('should correctly divide double primitive', () {
      ...
      const value2 = 1.5;
      final expected = Real(4.666666);
      final operation = (value1 / value2) as Real;
      expect(operation.value, closeTo(expected.value, 0.000002));
    });
    ...
    test('should correctly divide DoublePrecision', () {
      final value1 = SmallInteger(7);
      final value2 = DoublePrecision(1.5);
      final expected = DoublePrecision(4.666666666666667);
      final operation = (value1 / value2) as DoublePrecision;
      expect(operation.value, closeTo(expected.value, 0.000000000000002));
    });
...
//   outcome.
  group('fractional only floating point division (exact)', () {
    ...
    test('should correctly divide fractional Decimal', () {
      ...
      final expected = Decimal(value: '8', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
  });
...
//   of an integer by such a floating point number results in a fractional outcome.
  group('fractional only floating point division (fractional)', () {
    ...
    test('should correctly divide DoublePrecision', () {
      ...
      final expected = DoublePrecision(13.333333333333333);
      final operation = (value1 / value2) as DoublePrecision;
      expect(operation.value, closeTo(expected.value, 0.000000000000002));
    });
...
// an error occurs, highlighting the importance of operand order in division.
  group('zero divided by non-zero (zero + positive)', () {
    test('should return zero if dividing by positive BigInteger', () {
    ...
    test('should return zero if dividing by positive Integer', () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive SmallInteger', () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive BigSerial', () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive Serial', () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive SmallSerial', () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive int primitive', () {
      final value1 = SmallInteger(0);
      const value2 = 20;
      final expected = Real(0);
      final operation = value1 / value2;
    ...
    test(
        'should return zero if dividing by positive integer-valued double primitive',
        () {
      final value1 = SmallInteger(0);
      const value2 = 20.0;
      final expected = Real(0);
    ...
    test(
        'should return zero if dividing by positive fractional double primitive',
        () {
      final value1 = SmallInteger(0);
      const value2 = 20.5;
      final expected = Real(0);
    ...
    test('should return zero if dividing by positive integer-valued Real', () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive fractional Real', () {
      final value1 = SmallInteger(0);
    ...
    test(
        'should return zero if dividing by positive integer-valued DoublePrecision',
        () {
      final value1 = SmallInteger(0);
    ...
    test(
        'should return zero if dividing by positive fractional DoublePrecision',
        () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive int Numeric', () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive unconstrained int Numeric',
        () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive float Numeric', () {
      final value1 = SmallInteger(0);
    ...
    test(
        'should return zero if dividing by positive unconstrained float Numeric',
        () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive int Decimal', () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive unconstrained int Decimal',
        () {
      final value1 = SmallInteger(0);
    ...
    test('should return zero if dividing by positive float Decimal', () {
      final value1 = SmallInteger(0);
    ...
    test(
        'should return zero if dividing by positive unconstrained float Decimal',
        () {
      final value1 = SmallInteger(0);
...
//   designed to represent pure integer values.
  group('division by one', () {
    ...
    test('should return itself when dividing by DoublePrecision one', () {
      ...
      final expected = DoublePrecision(30);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should return itself when dividing by int Decimal one', () {
      ...
      final expected = Decimal(value: '30', precision: 22, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   on exact integer behavior.
  group('division by itself (positive)', () {
    ...
    test('should return one when dividing by int Decimal', () {
      ...
      final expected = Decimal(value: '1', precision: 21, scale: 20);
      final operation = value1 / value2;
      expect(operation.identicalTo(expected), true);
    });
...
//   ensures consistency across tests involving [Serial types].
  group('type casting', () {
    test('should return Real as result when dividing BigInteger', () {
    ...
    test('should return Real as result when dividing negative BigInteger', () {
      final value1 = SmallInteger(1);
      final value2 = BigInteger(-1);
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing Integer', () {
      final value1 = SmallInteger(1);
      final value2 = Integer(1);
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing negative Integer', () {
      final value1 = SmallInteger(1);
      final value2 = Integer(-1);
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing SmallInteger', () {
      final value1 = SmallInteger(1);
      final value2 = SmallInteger(1);
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing negative SmallInteger',
        () {
      final value1 = SmallInteger(1);
      final value2 = SmallInteger(-1);
      final operation = value1 / value2;
    ...
    test('should return Real as result when dividing BigSerial', () {
      final value1 = SmallInteger(1);
      final value2 = BigSerial(1);
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing Serial', () {
      final value1 = SmallInteger(1);
      final value2 = Serial(1);
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing SmallSerial', () {
      final value1 = SmallInteger(1);
      final value2 = SmallSerial(1);
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing int primitive', () {
      final value1 = SmallInteger(1);
      const value2 = 1;
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing negative int primitive',
        () {
      final value1 = SmallInteger(1);
      const value2 = -1;
      final operation = value1 / value2;
    ...
    test('should return Real as result when dividing double primitive', () {
      final value1 = SmallInteger(1);
      const value2 = 1.5;
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing negative double primitive',
        () {
      final value1 = SmallInteger(1);
      const value2 = -1.5;
      final operation = value1 / value2;
    ...
    test('should return Real as result when dividing Real', () {
      final value1 = SmallInteger(1);
      final value2 = Real(1);
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test('should return Real as result when dividing negative Real', () {
      final value1 = SmallInteger(1);
      final value2 = Real(-1);
      final operation = value1 / value2;
      expect(operation, isA<Real>());
    ...
    test(
        'should return DoublePrecision as result when dividing DoublePrecision',
        () {
      final value1 = SmallInteger(1);
      final value2 = DoublePrecision(1);
      final operation = value1 / value2;
    ...
    test(
        'should return DoublePrecision as result when dividing negative DoublePrecision',
        () {
      final value1 = SmallInteger(1);
      final value2 = DoublePrecision(-1);
      final operation = value1 / value2;
    ...
    test('should return Decimal as result when dividing Decimal', () {
      final value1 = SmallInteger(1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 / value2;
    ...
    test('should return Decimal as result when dividing negative Decimal', () {
      final value1 = SmallInteger(1);
      final value2 = Decimal(value: '1', precision: 1, scale: 0);
      final operation = value1 / value2;
      expect(operation, isA<Decimal>());
