...
// as it is uncommon to set a fractional value precisely to '0.0'.
  group('zero cases', () {
    ...
    // Observations:
    // In this test, the {value} '1231' is rounded to '-000' due to the -3 negative
    // {scale}.
    test(
...
// the minimum value constraint of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return Integer as result when subtracting SmallInteger', () {
      final value1 = Integer(1);
    ...
    test(
        'should return Integer as result when subtracting negative SmallInteger',
        () {
      final value1 = Integer(1);
      final value2 = SmallInteger(-1);
      final operation = value1 - value2;
    ...
    test('should return Integer as result when subtracting BigSerial', () {
      final value1 = Integer(1);
    ...
    test('should return Integer as result when subtracting Serial', () {
      final value1 = Integer(1);
    ...
    test('should return Integer as result when subtracting SmallSerial', () {
      final value1 = Integer(1);
    ...
    test('should return Integer as result when subtracting int primitive', () {
      final value1 = Integer(1);
      const value2 = 1;
      final operation = value1 - value2;
      expect(operation, isA<Integer>());
    ...
    test(
        'should return Integer as result when subtracting negative int primitive',
        () {
      final value1 = Integer(1);
      const value2 = -1;
      final operation = value1 - value2;
...
// tested in this file.
  group('operation type promotion', () {
    test(
      ...
      final value2 = BigInteger(20);
      final operation = value1 - value2;
      final expected = BigInteger(Integer.minValue - 20);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value2 = BigInteger(-20);
      final operation = value1 - value2;
      final expected = BigInteger(Integer.maxValue - (-20));
      expect(operation.identicalTo(expected), true);
    });
  });
