...
// tested in this file.
  group('operation type promotion', () {
    test(
      ...
      final value2 = BigInteger(20);
      final operation = value1 - value2;
      final expected = BigInteger(BigSerial.minValue - 20);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test('should promote correctly when subtracting Integer close to min value',
      ...
      final value2 = Integer(20);
      final operation = value1 - value2;
      final expected = Integer(BigSerial.minValue - 20);
      expect(operation.identicalTo(expected), true);
    });
    ...
    test(
      ...
      final value2 = SmallInteger(20);
      final operation = value1 - value2;
      final expected = SmallInteger(BigSerial.minValue - 20);
      expect(operation.identicalTo(expected), true);
    });
  });
...
// the minimum value constraint of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return BigSerial as result when subtracting Serial', () {
      final value1 = BigSerial(2);
    ...
    test('should return BigSerial as result when subtracting SmallSerial', () {
      final value1 = BigSerial(2);
    ...
    test('should return BigSerial as result when subtracting int primitive',
        () {
      final value1 = BigSerial(2);
      const value2 = 1;
      final operation = value1 - value2;
    ...
    test(
        'should return BigSerial as result when subtracting negative int primitive',
        () {
      final value1 = BigSerial(1);
      const value2 = -1;
      final operation = value1 - value2;
