...
//
  group('positive subtraction', () {
    ...
    test('should correctly subtract Numeric with negative scale', () {
      final value1 = SmallInteger(1950);
...
// is 1, and they cannot store negative values.
  group('negative result tests (negative + negative)', () {
    ...
    test(
        'should return negative value when subtracting Numeric with negative scale',
        () {
      final value1 = SmallInteger(-1900);
      final value2 = Numeric(value: '-1231', precision: 4, scale: -3);
      final expected = Numeric(value: '-900', precision: 3, scale: 0);
      final operation = value1 - value2;
      expect(operation.identicalTo(expected), true);
...
// the minimum value constraint of [Serial types], which is 1.
  group('type casting', () {
    ...
    test('should return SmallInteger as result when subtracting BigSerial', () {
      final value1 = SmallInteger(1);
    ...
    test('should return SmallInteger as result when subtracting Serial', () {
      final value1 = SmallInteger(1);
    ...
    test('should return SmallInteger as result when subtracting SmallSerial',
        () {
      final value1 = SmallInteger(1);
    ...
    test('should return SmallInteger as result when subtracting int primitive',
        () {
      final value1 = SmallInteger(1);
      const value2 = 1;
      final operation = value1 - value2;
    ...
    test(
        'should return SmallInteger as result when subtracting negative int primitive',
        () {
      final value1 = SmallInteger(1);
      const value2 = -1;
      final operation = value1 - value2;
