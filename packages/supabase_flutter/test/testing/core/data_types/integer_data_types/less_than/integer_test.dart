...
void main() {
// Tests if less than operator comparison works correctly with positive operands.
//
// This test group evaluates the correctness of the less than operator when used with
...
// to any [fractional] value.
  group('positive comparison', () {
    test('should return false if value is equal to BigInteger', () {
      expect(Integer(20) < BigInteger(20), false);
    });
    ...
    test('should return false if value is equal to Integer', () {
      expect(Integer(20) < Integer(20), false);
    });
    ...
    test('should return false if value is equal to SmallInteger', () {
      expect(Integer(20) < SmallInteger(20), false);
    });
    ...
    test('should return false if value is equal to BigSerial', () {
      expect(Integer(20) < BigSerial(20), false);
    });

    test('should return true if value is less than BigSerial', () {
      expect(Integer(20) < BigSerial(30), true);
    });
    ...
    test('should return false if value is equal to Serial', () {
      expect(Integer(20) < Serial(20), false);
    });

    test('should return true if value is less than Serial', () {
      expect(Integer(20) < Serial(30), true);
    });
    ...
    test('should return false if value is equal to SmallSerial', () {
      expect(Integer(20) < SmallSerial(20), false);
    });

    test('should return true if value is less than SmallSerial', () {
      expect(Integer(20) < SmallSerial(30), true);
    });
    ...
    test('should return false if value is equal to DoublePrecision', () {
      expect(Integer(20) < DoublePrecision(20), false);
    });
...
// Tests if less than operator comparison works correctly with negative operands.
//
// This test group evaluates the correctness of the less than operator when used with
...
// to any [fractional] value.
  group('negative comparison', () {
    ...
    test('should return true if value is less than BigInteger', () {
      expect(Integer(-30) < BigInteger(-20), true);
    });
    ...
    test('should return true if value is less than Integer', () {
      expect(Integer(-30) < Integer(-20), true);
    });
    ...
    test('should return true if value is less than SmallInteger', () {
      expect(Integer(-30) < SmallInteger(-20), true);
    });
    ...
    test('should return true if value is less than double primitive', () {
      expect(Integer(-30) < -20.5, true);
    });

    test('should return false if value is greater than double primitive', () {
      expect(Integer(-20) < -30.5, false);
    });
    ...
    test('should return true if value is less than Real', () {
      expect(Integer(-30) < Real(-20), true);
    });
    ...
    test('should return true if value is less than DoublePrecision', () {
      expect(Integer(-30) < DoublePrecision(-20), true);
    });
    ...
    test('should return true if value is less than int Numeric', () {
      final numeric = Numeric(value: '-20', precision: 2, scale: 0);
      expect(Integer(-30) < numeric, true);
    });
    ...
    test('should return true if value is less than int Decimal', () {
      final decimal = Decimal(value: '-20', precision: 2, scale: 0);
      expect(Integer(-30) < decimal, true);
    });
...
// Tests if less than operator comparison works correctly with the first operand being
...
// to any [fractional] value.
  group('zero with positive comparison', () {
    ...
    test('should return true if value is compared to BigSerial', () {
      expect(Integer(0) < BigSerial(30), true);
    });

    test('should return true if value is compared to Serial', () {
      expect(Integer(0) < Serial(30), true);
    });

    test('should return true if value is compared to SmallSerial', () {
      expect(Integer(0) < SmallSerial(30), true);
    });
...
// Tests if less than operator works correctly with zero operands.
//
// This test group evaluates the correctness of the less than operator when used with
...
// to any [fractional] value.
  group('zero with zero comparison', () {
    ...
    test('should return false if value compared to Real', () {
      expect(Integer(0) < Real(0), false);
    });

    test('should return false if value compared to DoublePrecision', () {
      expect(Integer(0) < DoublePrecision(0), false);
    });
