...
void main() {
  ...
  group('isAdjacent() tests', () {
    ...
    test('should return true if ranges are adjacent', () {
      ...
      expect(
        checkAdjacency('[2023-01-01, 2023-01-10]', '(2023-01-10, 2023-01-20)'),
        true,
      );
      expect(
        checkAdjacency('[2023-01-01, 2023-01-10]', '[2023-01-11, 2023-01-20]'),
        true,
      );
    });
    ...
    test('should return false if ranges are not adjacent', () {
      ...
      expect(
        checkAdjacency('[2023-01-01, 2023-01-10]', '[2023-01-12, 2023-01-20]'),
        false,
      );
      expect(
        checkAdjacency('[2023-01-01, 2023-01-10]', '[2023-01-21, 2023-01-30]'),
        false,
      );
    });
  });
  ...
  group('strictlyLeftOf() tests', () {
    ...
    test(
        ...
        () {
      expect(
        strictlyLeftOf('[2022-01-01, 2022-12-31]', '[2023-01-01, 2023-12-31]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        strictlyLeftOf('[2022-01-01, 2022-12-31]', '[2022-12-31, 2023-12-31]'),
        false,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        strictlyLeftOf('[2022-01-01, 2023-01-01]', '[2022-12-31, 2023-12-31]'),
        false,
      );
    });
  });
  ...
  group('strictlyLeftOf() unbounded tests', () {
    ...
    test('should return false if a [,] range is checked against a [b,] range',
        () {
      expect(strictlyLeftOf('[,]', '[2023-01-01,]'), false);
    });

    test('should return false if a [,] range is checked against a [,b] range',
        () {
      expect(strictlyLeftOf('[,]', '[,2023-12-31]'), false);
    });

    test('should return false if a [,] range is checked against a [b,b] range',
        () {
      expect(strictlyLeftOf('[,]', '[2023-01-01,2023-12-31]'), false);
    });

    test('should return false if a [b,] range is checked against a [,] range',
        () {
      expect(strictlyLeftOf('[2022-01-01,]', '[,]'), false);
    });

    test('should return false if a [,b] range is checked against a [,] range',
        () {
      expect(strictlyLeftOf('[,2022-12-31]', '[,]'), false);
    });

    test('should return false if a [b,b] range is checked against a [,] range',
        () {
      expect(strictlyLeftOf('[2022-01-01,2022-12-31]', '[,]'), false);
    });

    test('should return false if a [b,] range is checked against a [b,] range',
        () {
      expect(strictlyLeftOf('[2022-01-01,]', '[2023-10-01,]'), false);
    });

    test('should return false if a [b,] range is checked against a [,b] range',
        () {
      expect(strictlyLeftOf('[2022-01-01,]', '[,2023-12-31]'), false);
    });

    test('should return false if a [b,] range is checked against a [b,b] range',
        () {
      expect(strictlyLeftOf('[2022-01-01,]', '[2023-01-01,2023-12-31]'), false);
    });

    test(
        'should return true if the lower bound of a [,b] range is less than the upper bound of a [b,] range',
        () {
      expect(strictlyLeftOf('[,2022-12-31]', '[2023-01-01,]'), true);
    });

    test('should return false if a [,b] range is checked against a [,b] range',
        () {
      expect(strictlyLeftOf('[,2022-12-31]', '[,2023-12-31]'), false);
    });

    test(
        'should return true if the lower bound of a [,b] range is less than the upper bound of a [b,b] range',
        () {
      expect(strictlyLeftOf('[,2022-12-31]', '[2023-01-01,2023-12-31]'), true);
    });
  });
  ...
  group('strictlyRighttOf() tests', () {
    ...
    test(
        ...
        () {
      expect(
        strictlyRightOf('[2023-01-01, 2023-12-31]', '[2022-01-01, 2022-12-31]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        strictlyRightOf('[2023-01-01, 2023-12-31]', '[2022-01-01, 2023-12-31]'),
        false,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        strictlyRightOf('[2023-01-01, 2023-12-31]', '[2022-12-31, 2024-01-01]'),
        false,
      );
    });
  });
  ...
  group('strictlyRightOf() unbounded tests', () {
    ...
    test('should return false if a [,] range is checked against a [b,] range',
        () {
      expect(strictlyRightOf('[,]', '[2022-01-01,]'), false);
    });

    test('should return false if a [,] range is checked against a [,b] range',
        () {
      expect(strictlyRightOf('[,]', '[,2022-12-31]'), false);
    });

    test('should return false if a [,] range is checked against a [b,b] range',
        () {
      expect(strictlyRightOf('[,]', '[2022-01-01,2022-12-31]'), false);
    });

    test('should return false if a [b,] range is checked against a [,] range',
        () {
      expect(strictlyRightOf('[2023-01-01,]', '[,]'), false);
    });

    test('should return false if a [,b] range is checked against a [,] range',
        () {
      expect(strictlyRightOf('[,2023-12-31]', '[,]'), false);
    });

    test('should return false if a [b,b] range is checked against a [,] range',
        () {
      expect(strictlyRightOf('[2023-01-01,2023-12-31]', '[,]'), false);
    });

    test('should return false if a [b,] range is checked against a [b,] range',
        () {
      expect(strictlyRightOf('[2023-01-01,]', '[2022-01-01,]'), false);
    });

    test(
        'should return true if the lower bound of a [b,] range is greater than the upper bound of a [,b] range',
        () {
      expect(strictlyRightOf('[2023-01-01,]', '[,2022-12-31]'), true);
    });

    test(
        'should return true if the lower bound of a [b,] range is greater than the upper bound of a [b,b] range',
        () {
      expect(strictlyRightOf('[2023-01-01,]', '[2022-01-01,2022-12-31]'), true);
    });

    test('should return false if a [,b] range is checked against a [b,] range',
        () {
      expect(strictlyRightOf('[,2023-12-31]', '[2022-01-01,]'), false);
    });

    test('should return false if a [,b] range is checked against a [,b] range',
        () {
      expect(strictlyRightOf('[,2023-12-31]', '[,2022-12-31]'), false);
    });

    test('should return false if a [,b] range is checked against a [b,b] range',
        () {
      expect(
        strictlyRightOf('[,2023-12-31]', '[2022-01-01,2022-12-31]'),
        false,
      );
    });
  });
  ...
  group('doesNotExtendToTheLeftOf() tests', () {
    ...
    test(
      ...
      expect(
        doesNotExtendToTheLeftOf(
            '[2022-01-01, 2023-12-31]', '[2022-01-01, 2022-12-31]'),
        true,
      );
    });
    ...
    test(
      ...
      expect(
        doesNotExtendToTheLeftOf(
            '[2022-01-01, 2023-12-31]', '[2022-12-31, 2024-01-01]'),
        false,
      );
    });
  });
  ...
  group('doesNotExtendToTheLeftOf() unbounded tests', () {
    ...
    test('should return false if a [,] range is checked against a [b,] range',
        () {
      expect(doesNotExtendToTheLeftOf('[,]', '[2022-01-01,]'), false);
    });

    test('should return true if a [,] range is checked against a [,b] range',
        () {
      expect(doesNotExtendToTheLeftOf('[,]', '[,2022-12-31]'), true);
    });

    test('should return false if a [,] range is checked against a [b,b] range',
        () {
      expect(
        doesNotExtendToTheLeftOf('[,]', '[2022-01-01,2022-12-31]'),
        false,
      );
    });
    ...
    test('should return true if a [b,] range is checked against a [,] range',
        () {
      expect(doesNotExtendToTheLeftOf('[2023-01-01,]', '[,]'), true);
    });

    test('should return true if a [,b] range is checked against a [,] range',
        () {
      expect(doesNotExtendToTheLeftOf('[,2023-12-31]', '[,]'), true);
    });

    test('should return true if a [b,b] range is checked against a [,] range',
        () {
      expect(
        doesNotExtendToTheLeftOf('[2023-01-01,2023-12-31]', '[,]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheLeftOf('[2023-01-01,]', '[2022-01-01,2022-12-31]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheLeftOf('[2023-01-01,]', '[2023-01-01,2023-12-31]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheLeftOf('[2023-01-01,]', '[2023-12-31,2024-01-01]'),
        false,
      );
    });
    ...
    test('should return false if a [,b] range is checked against a [b,] range',
        () {
      expect(doesNotExtendToTheLeftOf('[,2023-01-01]', '[2022-01-01,]'), false);
    });

    test('should return false if a [,b] range is checked against a [,b] range',
        () {
      expect(doesNotExtendToTheLeftOf('[,2023-01-01]', '[,2022-12-31]'), false);
    });
  ...
  group('doesNotExtendToTheRightOf() tests', () {
    ...
    test(
      ...
      expect(
        doesNotExtendToTheRightOf(
            '[2022-01-01, 2023-12-31]', '[2023-01-01, 2023-12-31]'),
        true,
      );
    });
    ...
    test(
      ...
      expect(
        doesNotExtendToTheRightOf(
            '[2022-01-01, 2023-12-31]', '[2023-01-01, 2023-06-01]'),
        false,
      );
    });
  });
  ...
  group('doesNotExtendToTheRightOf() unbounded tests', () {
    ...
    test('should return true if a [,] range is checked against a [b,] range',
        () {
      expect(doesNotExtendToTheRightOf('[,]', '[2023-01-01,]'), true);
    });

    test('should return false if a [,] range is checked against a [,b] range',
        () {
      expect(doesNotExtendToTheRightOf('[,]', '[,2023-12-31]'), false);
    });

    test('should return false if a [,] range is checked against a [b,b] range',
        () {
      expect(
        doesNotExtendToTheRightOf('[,]', '[2023-01-01,2023-12-31]'),
        false,
      );
    });
    ...
    test('should return true if a [b,] range is checked against a [,] range',
        () {
      expect(doesNotExtendToTheRightOf('[2022-01-01,]', '[,]'), true);
    });

    test('should return true if a [,b] range is checked against a [,] range',
        () {
      expect(doesNotExtendToTheRightOf('[,2022-12-31]', '[,]'), true);
    });

    test('should return true if a [b,b] range is checked against a [,] range',
        () {
      expect(
        doesNotExtendToTheRightOf('[2022-01-01,2022-12-31]', '[,]'),
        true,
      );
    });
    ...
    test('should return true if a [b,] range is compared against a [b,] range',
        () {
      expect(
        doesNotExtendToTheRightOf('[2022-01-01,]', '[2023-01-01,]'),
        true,
      );
    });
    ...
    test('should return false if a [b,] range is checked against a [,b] range',
        () {
      expect(
        doesNotExtendToTheRightOf('[2022-01-01,]', '[,2023-12-31]'),
        false,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheRightOf('[2022-01-01,]', '[2023-01-01,2023-12-31]'),
        false,
      );
    });
    ...
    test('should return true if a [,b] range is checked against a [b,] range',
        () {
      expect(
        doesNotExtendToTheRightOf('[,2022-12-31]', '[2023-01-01,]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheRightOf('[,2022-12-31]', '[,2023-12-31]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheRightOf('[,2022-12-31]', '[,2022-12-31]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheRightOf('[,2022-12-31]', '[,2022-01-01]'),
        false,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheRightOf('[,2022-12-31]', '[2021-01-01,2023-12-31]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheRightOf('[,2022-12-31]', '[2021-01-01,2022-12-31]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        doesNotExtendToTheRightOf('[,2022-12-31]', '[2021-01-01,2022-01-01]'),
        false,
      );
    });
  });
