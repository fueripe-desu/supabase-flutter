...
void main() {
  ...
  group('unbounded range tests', () {
    ...
    test('should be able to create a [b,] range', () {
      expect(
          () => createRange('[2022-01-01T00:00:00.999-01,]'), returnsNormally);
      expect(
    ...
    test('should be able to create a [,b] range', () {
      expect(
          () => createRange('[,2022-01-01T15:00:00.999+01]'), returnsNormally);
      expect(
  ...
  group('strictlyLeftOf() tests', () {
    ...
    test(
      ...
      expect(
        strictlyLeftOf(
          '[2022-01-01T00:00:00.000-01, 2022-12-31T00:00:00.000+01]',
          '[2023-01-01T00:00:00.000-01, 2023-12-31T00:00:00.000+01]',
        ),
        true,
      );
    });
    ...
    test(
      ...
      expect(
        strictlyLeftOf(
          '[2022-01-01T00:00:00.000-01, 2022-12-31T00:00:00.000+01]',
          '[2022-12-31T00:00:00.000+01, 2023-12-31T00:00:00.000-01]',
        ),
        false,
      );
    });
  ...
  group('strictlyLeftOf() unbounded tests', () {
    ...
    test('should return false if a [,] range is checked against a [b,] range',
        () {
      expect(strictlyLeftOf('[,]', '[2023-01-01T00:00:00.000-01,]'), false);
    });

    test('should return false if a [,] range is checked against a [,b] range',
        () {
      expect(strictlyLeftOf('[,]', '[,2023-12-31T00:00:00.000+01]'), false);
    });
    ...
    test('should return false if a [b,] range is checked against a [,] range',
        () {
      expect(strictlyLeftOf('[2022-01-01T00:00:00.000-01,]', '[,]'), false);
    });

    test('should return false if a [,b] range is checked against a [,] range',
        () {
      expect(strictlyLeftOf('[,2022-12-31T00:00:00.000+01]', '[,]'), false);
    });
    ...
    test('should return false if a [b,] range is checked against a [,b] range',
      ...
      expect(
        strictlyLeftOf(
            '[2022-01-01T00:00:00.000-01,]', '[,2023-12-31T00:00:00.000+01]'),
        false,
      );
    });
    ...
    test(
      ...
      expect(
        strictlyLeftOf(
            '[,2022-12-31T00:00:00.000+01]', '[2023-01-01T00:00:00.000-01,]'),
        true,
      );
    });
    ...
    test(
        ...
        () {
      expect(
        strictlyLeftOf('[,2022-12-31T00:00:00.000+01]',
            '[2023-01-01T00:00:00.000-01,2023-12-31T00:00:00.000+01]'),
        true,
      );
    });
  ...
  group('strictlyRighttOf() tests', () {
    ...
    test(
      ...
      expect(
        strictlyRightOf(
          '[2023-01-01T00:00:00.000-01, 2023-12-31T00:00:00.000+01]',
          '[2022-12-31T00:00:00.000-01, 2024-01-01T00:00:00.000+01]',
        ),
        false,
      );
    });
  ...
  group('strictlyRightOf() unbounded tests', () {
    ...
    test('should return false if a [,] range is checked against a [b,] range',
        () {
      expect(strictlyRightOf('[,]', '[2022-01-01T00:00:00.000-01,]'), false);
    });

    test('should return false if a [,] range is checked against a [,b] range',
        () {
      expect(strictlyRightOf('[,]', '[,2022-12-31T00:00:00.000+01]'), false);
    });
    ...
    test('should return false if a [b,] range is checked against a [,] range',
        () {
      expect(strictlyRightOf('[2023-01-01T00:00:00.000-01,]', '[,]'), false);
    });

    test('should return false if a [,b] range is checked against a [,] range',
        () {
      expect(strictlyRightOf('[,2023-12-31T00:00:00.000+01]', '[,]'), false);
    });
    ...
    test('should return false if a [b,] range is checked against a [b,] range',
      ...
      expect(
        strictlyRightOf(
            '[2023-01-01T00:00:00.000-01,]', '[2022-01-01T00:00:00.000-01,]'),
        false,
      );
    });
    ...
    test(
      ...
      expect(
        strictlyRightOf(
            '[2023-01-01T00:00:00.000-01,]', '[,2022-12-31T00:00:00.000+01]'),
        true,
      );
    });
    ...
    test('should return false if a [,b] range is checked against a [b,] range',
      ...
      expect(
        strictlyRightOf(
            '[,2023-12-31T00:00:00.000+01]', '[2022-01-01T00:00:00.000-01,]'),
        false,
      );
    });
    ...
    test('should return false if a [,b] range is checked against a [,b] range',
      ...
      expect(
        strictlyRightOf(
            '[,2023-12-31T00:00:00.000+01]', '[,2022-12-31T00:00:00.000+01]'),
        false,
      );
    });
  ...
  group('doesNotExtendToTheLeftOf() unbounded tests', () {
    ...
    test('should return false if a [,] range is checked against a [b,] range',
        () {
      expect(doesNotExtendToTheLeftOf('[,]', '[2022-01-01T00:00:00.000-01,]'),
          false);
    });

    test('should return true if a [,] range is checked against a [,b] range',
        () {
      expect(doesNotExtendToTheLeftOf('[,]', '[,2022-12-31T00:00:00.000+01]'),
          true);
    });
    ...
    test('should return true if a [b,] range is checked against a [,] range',
        () {
      expect(doesNotExtendToTheLeftOf('[2023-01-01T00:00:00.000-01,]', '[,]'),
          true);
    });

    test('should return true if a [,b] range is checked against a [,] range',
        () {
      expect(doesNotExtendToTheLeftOf('[,2023-12-31T00:00:00.000+01]', '[,]'),
          true);
    });
    ...
    test(
      ...
      expect(
        doesNotExtendToTheLeftOf(
          '[2023-01-01T00:00:00.000-01,]',
          '[2023-12-31T00:00:00.000-01,2024-01-01T00:00:00.000+01]',
        ),
        false,
      );
    });
  ...
  group('doesNotExtendToTheRightOf() tests', () {
    ...
    test(
      ...
      expect(
        doesNotExtendToTheRightOf(
          '[2022-01-01T00:00:00.000-01, 2023-12-31T00:00:00.000+01]',
          '[2023-01-01T00:00:00.000-01, 2023-06-01T00:00:00.000+01]',
        ),
        false,
      );
    });
  ...
  group('doesNotExtendToTheRightOf() unbounded tests', () {
    ...
    test('should return true if a [,] range is checked against a [b,] range',
        () {
      expect(doesNotExtendToTheRightOf('[,]', '[2023-01-01T00:00:00.000-01,]'),
          true);
    });

    test('should return false if a [,] range is checked against a [,b] range',
        () {
      expect(doesNotExtendToTheRightOf('[,]', '[,2023-12-31T00:00:00.000-01]'),
          false);
    });
    ...
    test('should return true if a [b,] range is checked against a [,] range',
        () {
      expect(doesNotExtendToTheRightOf('[2022-01-01T00:00:00.000-01,]', '[,]'),
          true);
    });

    test('should return true if a [,b] range is checked against a [,] range',
        () {
      expect(doesNotExtendToTheRightOf('[,2022-12-31T00:00:00.000+01]', '[,]'),
          true);
    });
    ...
    test(
      ...
      expect(
        doesNotExtendToTheRightOf(
          '[,2022-12-31T00:00:00.000+01]',
          '[2021-01-01T00:00:00.000-01,2023-12-31T00:00:00.000+01]',
        ),
        true,
      );
    });
  ...
  group('comparison unbounded tests', () {
    ...
    group('range equality', () {
      test('should return true if the ranges have the same values', () {
        expect(
            eq('[2022-01-01T00:00:00-01,]', '[2022-01-01T00:00:00-01,]'), true);
        expect(
            eq('(2022-01-01T00:00:00-01,]', '(2022-01-01T00:00:00-01,]'), true);
        expect(
            eq('[2022-01-01T00:00:00-01,)', '[2022-01-01T00:00:00-01,)'), true);
        ...
        expect(
            eq('[,2022-12-31T00:00:00-01]', '[,2022-12-31T00:00:00-01]'), true);
        expect(
            eq('(,2022-12-31T00:00:00-01]', '(,2022-12-31T00:00:00-01]'), true);
        expect(
            eq('[,2022-12-31T00:00:00-01)', '[,2022-12-31T00:00:00-01)'), true);
